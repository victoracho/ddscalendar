...
var Sn = (t, e, l) => e in t ? Tn(t, e, { enumerable: true, configurable: true, writable: true, value: l }) : t[e] = l;
...
var ua = (t, e) => computed(() => {
  const l = toValue(t), a = toValue(e);
  return l === true ? "true" : typeof l == "string" ? l : a === false ? "true" : l === false ? "false" : void 0;
});
var nt = class _nt {
  constructor(e, l = {}) {
    ze(this, "cancelable", true);
    ze(this, "componentId", null);
    ze(this, "_defaultPrevented", false);
    ze(this, "eventType", "");
    ...
    Object.assign(this, _nt.Defaults, l, { eventType: e }), this._preventDefault = function() {
...
var Ae = (t) => ((t == null ? void 0 : t()) ?? []).length === 0;
var Fn = (t) => {
...
var za = typeof window < "u" && typeof document < "u" && typeof navigator < "u";
var zn = (t) => (() => {
  let l = false;
  if (za)
    try {
  ...
  return l;
})() ? typeof t == "object" ? t : { capture: !!t || false } : typeof t == "object" ? t.capture : t;
var Hn = (t, e, l, a) => {
...
var rl = ["start", "end"];
var il = Wl.reduce((t, e) => t.concat(e, e + "-" + rl[0], e + "-" + rl[1]), []);
var et = Math.min;
var Ie = Math.max;
var ea = Math.round;
var Ut = Math.floor;
...
var Xn = async (t, e, l) => {
  ...
  for (let c = 0; c < s.length; c++) {
    ...
    }, w && y <= 50 && (y++, typeof w == "object" && (w.placement && (f = w.placement), w.rects && (u = w.rects === true ? await n.getElementRects({
      reference: t,
      floating: e,
      strategy: o
    }) : w.rects), {
...
var Kn = (t) => ({
  ...
  async fn(e) {
    ...
    const p = Ma(d), f = {
      x: l,
      y: a
    }, m = Ra(o), y = Ha(m), c = await n.getDimensions(u), g = m === "y", v = g ? "top" : "left", h2 = g ? "bottom" : "right", k = g ? "clientHeight" : "clientWidth", C = r.reference[y] + r.reference[m] - f[m] - r.floating[y], w = f[m] - r.reference[m], _ = await (n.getOffsetParent == null ? void 0 : n.getOffsetParent(u));
    let F = _ ? _[k] : 0;
    (!F || !await (n.isElement == null ? void 0 : n.isElement(_))) && (F = s.floating[k] || r.floating[y]);
    const Q = C / 2 - w / 2, W = F / 2 - c[y] / 2 - 1, L = et(p[v], W), J = et(p[h2], W), R = L, le = F - c[y] - J, N = F / 2 - c[y] / 2 + Q, S = Ca(R, N, le), E = !i.arrow && Ze(o) != null && N !== S && r.reference[y] / 2 - (N < R ? L : J) - c[y] / 2 < 0, M = E ? N < R ? N - R : N - le : 0;
    return {
      [m]: f[m] + M,
      data: {
        [m]: S,
...
function Yn(t, e, l) {
  return (t ? [...l.filter((o) => Ze(o) === t), ...l.filter((o) => Ze(o) !== t)] : l.filter((o) => Ge(o) === o)).filter((o) => t ? Ze(o) === t || (e ? ta(o) !== o : false) : true);
}
var Jn = function(t) {
  return t === void 0 && (t = {}), {
    name: "autoPlacement",
    ...
    async fn(e) {
      ...
      const {
        ...
        ...y
      } = dt(t, e), c = p !== void 0 || f === il ? Yn(p || null, m, f) : f, g = await At(e, y), v = ((l = n.autoPlacement) == null ? void 0 : l.index) || 0, h2 = c[v];
      if (h2 == null)
        return {};
      const k = Ul(h2, r, await (i.isRTL == null ? void 0 : i.isRTL(u.floating)));
      if (s !== h2)
        return {
          reset: {
            placement: c[0]
      ...
      const C = [g[Ge(h2)], g[k[0]], g[k[1]]], w = [...((a = n.autoPlacement) == null ? void 0 : a.overflows) || [], {
        placement: h2,
        overflows: C
      }], _ = c[v + 1];
      if (_)
  ...
  return t === void 0 && (t = {}), {
    ...
    async fn(e) {
      ...
      if ((l = r.arrow) != null && l.alignmentOffset)
        return {};
      const v = Ge(o), h2 = Ge(s) === s, k = await (i.isRTL == null ? void 0 : i.isRTL(u.floating)), C = f || (h2 || !c ? [aa(s)] : qn(s));
    ...
    async fn(e) {
      ...
      function y() {
        ...
        if (p.length >= 2) {
          ...
          const g = Ge(l) === "left", v = Ie(...p.map((L) => L.right)), h2 = et(...p.map((L) => L.left)), k = p.filter((L) => g ? L.left === h2 : L.right === v), C = k[0].top, w = k[k.length - 1].bottom, _ = h2, F = v, Q = F - _, W = w - C;
          return {
            top: C,
            bottom: w,
            left: _,
...
var ls = function(t) {
  return t === void 0 && (t = {}), {
    ...
    async fn(e) {
      ...
      let m = u[f], y = u[p];
      if (r) {
        const g = f === "y" ? "top" : "left", v = f === "y" ? "bottom" : "right", h2 = m + d[g], k = m - d[v];
        m = Ca(h2, m, k);
      }
      if (n) {
        const g = p === "y" ? "top" : "left", v = p === "y" ? "bottom" : "right", h2 = y + d[g], k = y - d[v];
        y = Ca(h2, y, k);
      }
      const c = s.fn({
        ...e,
...
var os = function(t) {
  return t === void 0 && (t = {}), {
    ...
    async fn(e) {
      ...
      const g = m - i[y], v = f - i[c], h2 = !e.middlewareData.shift;
      let k = g, C = v;
      if (p) {
...
function fl(t) {
  return typeof ShadowRoot > "u" ? false : t instanceof ShadowRoot || t instanceof xe(t).ShadowRoot;
}
function jt(t) {
  const {
    overflow: e,
...
function Da(t) {
  const e = ja(), l = Ue(t);
  return l.transform !== "none" || l.perspective !== "none" || (l.containerType ? l.containerType !== "normal" : false) || !e && (l.backdropFilter ? l.backdropFilter !== "none" : false) || !e && (l.filter ? l.filter !== "none" : false) || ["transform", "perspective", "filter"].some((a) => (l.willChange || "").includes(a)) || ["paint", "layout", "strict", "content"].some((a) => (l.contain || "").includes(a));
}
function Yl(t) {
  let e = Ot(t);
  for (; at(e) && !da(e); ) {
...
function rs(t, e, l) {
  return e === void 0 && (e = false), !l || e && l !== xe(t) ? false : e;
}
function yt(t, e, l, a) {
  e === void 0 && (e = false), l === void 0 && (l = false);
  ...
  if (r) {
    ...
    for (; y && a && m !== f; ) {
      const c = Vt(y), g = y.getBoundingClientRect(), v = Ue(y), h2 = g.left + (y.clientLeft + parseFloat(v.paddingLeft)) * c.x, k = g.top + (y.clientTop + parseFloat(v.paddingTop)) * c.y;
      i *= c.x, u *= c.y, d *= c.x, p *= c.y, i += h2, u += k, y = xe(y).frameElement;
    }
  }
  return _t({
    width: d,
...
function us(t) {
  ...
  const r = ct(a), [n] = e ? eo(e.floating) : [false];
  if (a === r || n)
    return l;
  let s = {
    scrollLeft: 0,
...
function vs(t, e) {
  const l = yt(t, true, e === "fixed"), a = l.top + t.clientTop, o = l.left + t.clientLeft, r = at(t) ? Vt(t) : pt(1), n = t.clientWidth * r.x, s = t.clientHeight * r.y, i = o * r.x, u = a * r.y;
  return {
    width: n,
    height: s,
    x: i,
...
function ao(t, e) {
  const l = Ot(t);
  return l === e || !rt(l) || da(l) ? false : Ue(l).position === "fixed" || ao(l, e);
}
function ps(t, e) {
  const l = e.get(t);
  if (l)
    return l;
  let a = Ft(t, [], false).filter((s) => rt(s) && st(s) !== "body"), o = null;
...
function ys(t, e, l, a) {
  const o = at(e), r = ct(e), n = l === "fixed", s = yt(t, true, n, e);
  let i = {
    scrollLeft: 0,
    scrollTop: 0
  };
...
function ws(t, e) {
  ...
  function n(s, i) {
    s === void 0 && (s = false), i === void 0 && (i = 1), r();
    const {
      left: u,
      top: d,
      width: p,
    ...
    if (s || e(), !p || !f)
      return;
    const m = Ut(d), y = Ut(o.clientWidth - (u + p)), c = Ut(o.clientHeight - (d + f)), g = Ut(u), h2 = {
    ...
    try {
      ...
      l = new IntersectionObserver(C, h2);
    }
    l.observe(t);
  }
  return n(true), r;
...
function oo(t, e, l, a) {
  ...
  n && (m = new ResizeObserver((v) => {
    let [h2] = v;
    h2 && h2.target === u && m && (m.unobserve(e), cancelAnimationFrame(f), f = requestAnimationFrame(() => {
      var k;
  ...
  return l(), () => {
    var v;
    d.forEach((h2) => {
      o && h2.removeEventListener("scroll", l), r && h2.removeEventListener("resize", l);
...
function uo(t, e, l) {
  ...
  }), r = computed(() => unref(l.middleware)), n = computed(() => {
    var F;
  ...
  }), u = computed(() => ka(t.value)), d = computed(() => ka(e.value)), p = ref(0), f = ref(0), m = ref(s.value), y = ref(n.value), c = shallowRef({}), g = ref(false), v = computed(() => {
    const F = {
      position: m.value,
      left: "0",
      top: "0"
  ...
  function k() {
    u.value == null || d.value == null || Ss(u.value, d.value, {
      ...
      p.value = F.x, f.value = F.y, m.value = F.strategy, y.value = F.placement, c.value = F.middlewareData, g.value = true;
    });
  }
  function C() {
  ...
  return watch([r, n, s], k, {
    ...
    middlewareData: shallowReadonly(c),
...
var Os = /^aria-[\w-]*$/i;
var Ns = /^(?:(?:https?|mailto|ftp|tel|file|sms):|[^#&/:?]*(?:[#/?]|$))/i;
var Is = /^data:(?:image\/(?:bmp|gif|jpeg|jpg|png|tiff|webp)|video\/(?:mpeg|mp4|ogg|webm)|audio\/(?:mp3|oga|ogg|opus));base64,[\d+/a-z]+=*$/i;
var Ps = (t, e) => {
  const l = t.nodeName.toLowerCase();
  return e.includes(l) ? As.has(l) ? !!(Ns.test(t.nodeValue || "") || Is.test(t.nodeValue || "")) : true : e.filter((a) => a instanceof RegExp).some((a) => a.test(l));
};
var $t = {
...
var la = typeof window < "u" && typeof document < "u";
typeof WorkerGlobalScope < "u" && globalThis instanceof WorkerGlobalScope;
var Ls = (t) => typeof t < "u";
var co = (t) => t != null;
var Fs = Object.prototype.toString;
var zs = (t) => Fs.call(t) === "[object Object]";
var We = () => {
};
var $a = Hs();
function Hs() {
...
function Ms(t = vo) {
  ...
  return { isActive: readonly(e), pause: l, resume: a, eventFilter: o };
}
function xs(t) {
...
var Ds = /-(\w)/g;
var js = xs((t) => t.replace(Ds, (e, l) => l ? l.toUpperCase() : ""));
function qs(t) {
...
function po(...t) {
  if (t.length !== 1)
    return toRef(...t);
  const e = t[0];
  return typeof e == "function" ? readonly(customRef(() => ({ get: e, set: We }))) : ref(e);
}
...
function mo(t, e = true, l) {
  qs() ? onMounted(t, l) : e ? t() : nextTick(t);
}
function bo(t, e = 1e3, l = {}) {
  ...
  function u() {
    const d = Le(e);
    d <= 0 || (n.value = true, o && t(), s(), r = setInterval(t, d));
  }
  if (a && la && u(), isRef(e) || typeof e == "function") {
    const d = watch(e, () => {
      n.value && la && u();
    });
    it(d);
...
function zt(t = {}) {
  const {
    inheritAttrs: e = true
  } = t, l = shallowRef(), a = defineComponent({
    setup(r, { slots: n }) {
      return () => {
        l.value = n.default;
      };
...
function ke(...t) {
  ...
  }, s = (d, p, f, m) => (d.addEventListener(p, f, m), () => d.removeEventListener(p, f, m)), i = watch(
    () => [Me(e), Le(o)],
    ([d, p]) => {
      if (n(), !d)
        return;
...
var bl = false;
function yo(t, e, l = {}) {
  const { window: a = De, ignore: o = [], capture: r = true, detectIframe: n = false } = l;
  if (!a)
    return We;
  $a && !bl && (bl = true, Array.from(a.document.body.children).forEach((f) => f.addEventListener("click", We)), a.document.documentElement.addEventListener("click", We));
  let s = true;
  const i = (f) => o.some((m) => {
    if (typeof m == "string")
...
function Re(...t) {
  let e, l, a = {};
  t.length === 3 ? (e = t[0], l = t[1], a = t[2]) : t.length === 2 ? typeof t[1] == "object" ? (e = true, l = t[0], a = t[1]) : (e = t[0], l = t[1]) : (e = true, l = t[0]);
  const {
    target: o = De,
    eventName: r = "keydown",
    passive: n = false,
...
function Ks() {
  const t = ref(false), e = getCurrentInstance();
  return e && onMounted(() => {
    t.value = true;
  }, e), t;
}
...
var Kt = "__vueuse_ssr_handlers__";
var Zs = Qs();
function Qs() {
...
function ar(t, e, l, a = {}) {
  ...
  const {
    ...
    initOnMounted: y
  } = a, c = (d ? shallowRef : ref)(typeof e == "function" ? e() : e);
  if (!l)
    try {
  ...
  if (!l)
    return c;
  const g = Le(e), v = er(g), h2 = (o = a.serializer) != null ? o : tr[v], { pause: k, resume: C } = Ta(
    c,
    () => _(c.value),
  ...
  function F(L) {
    ...
    if (J == null)
      return i && g != null && l.setItem(t, h2.write(g)), g;
    if (!L && u) {
      const R = h2.read(J);
      return typeof u == "function" ? u(R, g) : v === "object" && !Array.isArray(R) ? { ...g, ...R } : R;
    } else
      return typeof J != "string" ? J : h2.read(J);
  }
  function Q(L) {
    if (!(L && L.storageArea !== l)) {
      ...
      if (!(L && L.key !== t)) {
        k();
        try {
          (L == null ? void 0 : L.newValue) !== h2.write(c.value) && (c.value = F(L));
        } catch (J) {
          m(J);
        } finally {
          L ? nextTick(C) : C();
...
function or(t = {}) {
  const {
    ...
    storageRef: i,
    emitAuto: u,
    disableTransition: d = true
  } = t, p = {
    auto: "",
    light: "light",
    dark: "dark",
    ...t.modes || {}
  }, f = lr({ window: o }), m = computed(() => f.value ? "dark" : "light"), y = i || (n == null ? po(a) : ar(n, a, r, { window: o, listenToStorageChanges: s })), c = computed(() => y.value === "auto" ? m.value : y.value), g = Ga(
    "updateHTMLAttrs",
    (C, w, _) => {
  ...
  watch(c, h2, { flush: "post", immediate: true }), mo(() => h2(c.value));
  const k = computed({
    get() {
...
function Ua(t, e = {}) {
  ...
  return o && (ke(t, "mouseenter", () => s(true), { passive: true }), ke(t, "mouseleave", () => s(false), { passive: true })), r;
}
function sr(t, e, l = {}) {
  const {
    root: a,
    ...
    window: n = De,
    immediate: s = true
  } = l, i = Wa(() => n && "IntersectionObserver" in n), u = computed(() => {
    const y = Le(t);
    return (Array.isArray(y) ? y : [y]).map(Me).filter(co);
  });
  let d = We;
  const p = ref(s), f = i.value ? watch(
...
function Pe(t, e = {}) {
  const { initialValue: l = false, focusVisible: a = false } = e, o = ref(false), r = computed(() => Me(t));
  ke(r, "focus", (s) => {
    var i, u;
    (!a || (u = (i = s.target).matches) != null && u.call(i, ":focus-visible")) && (o.value = true);
  }), ke(r, "blur", () => o.value = false);
  const n = computed({
    get: () => o.value,
    set(s) {
      var i, u;
...
function ir(t = {}) {
  ...
  let u = null;
  const d = ref(o.x), p = ref(o.y), f = ref(null), m = typeof e == "function" ? e : rr[e], y = (w) => {
    const _ = m(w);
  ...
  }, h2 = i ? (w) => i(() => y(w), {}) : (w) => y(w), k = i ? (w) => i(() => c(w), {}) : (w) => c(w), C = i ? () => i(() => g(), {}) : () => g();
  if (n) {
    const w = { passive: true };
    ke(n, ["mousemove", "dragover"], h2, w), l && e !== "movement" && (ke(n, ["touchstart", "touchmove"], k, w), a && ke(n, "touchend", v, w)), s && e === "page" && ke(r, "scroll", C, { passive: true });
  }
  return {
    x: d,
    y: p,
...
function gl(t, e = {}) {
  const {
    ...
    window: a = De
  } = e, o = e.type || "page", { x: r, y: n, sourceType: s } = ir(e), i = ref(t ?? (a == null ? void 0 : a.document.body)), u = ref(0), d = ref(0), p = ref(0), f = ref(0), m = ref(0), y = ref(0), c = ref(true);
  let g = () => {
  };
  return a && (g = watch(
    [i, r, n],
    () => {
      ...
      p.value = h2 + (o === "page" ? a.pageXOffset : 0), f.value = k + (o === "page" ? a.pageYOffset : 0), m.value = w, y.value = C;
...
function go(t) {
    ...
    return true;
  {
    ...
    return !l || l.tagName === "BODY" ? false : go(l);
  }
}
function ur(t) {
  const e = t || window.event, l = e.target;
  return go(l) ? false : e.touches.length > 1 ? true : (e.preventDefault && e.preventDefault(), false);
}
...
function dr(t, e = false) {
  ...
  const o = () => {
    ...
    !n || l.value || ($a && (a = ke(
      ...
      { passive: false }
    )), n.style.overflow = "hidden", l.value = true);
  }, r = () => {
    var n;
    const s = ba(Le(t));
    !s || !l.value || ($a && (a == null || a()), s.style.overflow = (n = Yt.get(s)) != null ? n : "", Yt.delete(s), l.value = false);
  };
  return it(r), computed({
    get() {
      return l.value;
    },
    set(n) {
...
function cr(t, e = {}) {
  const {
    ...
    passive: n = true,
    window: s = De
  } = e, i = reactive({ x: 0, y: 0 }), u = reactive({ x: 0, y: 0 }), d = computed(() => i.x - u.x), p = computed(() => i.y - u.y), { max: f, abs: m } = Math, y = computed(() => f(m(d.value), m(p.value)) >= l), c = ref(false), g = computed(() => y.value ? m(d.value) > m(p.value) ? d.value > 0 ? "left" : "right" : p.value > 0 ? "up" : "down" : "none"), v = (W) => [W.touches[0].clientX, W.touches[0].clientY], h2 = (W, L) => {
    i.x = W, i.y = L;
  }, k = (W, L) => {
    u.x = W, u.y = L;
  };
  ...
  n ? C = w ? { passive: true } : { capture: false } : C = w ? { passive: false, capture: true } : { capture: true };
  const _ = (W) => {
    c.value && (o == null || o(W, g.value)), c.value = false;
  }, F = [
    ke(t, "touchstart", (W) => {
      ...
      const [L, J] = v(W);
      h2(L, J), k(L, J), r == null || r(W);
    }, C),
    ke(t, "touchmove", (W) => {
      if (W.touches.length !== 1)
        return;
      const [L, J] = v(W);
      k(L, J), !c.value && y.value && (c.value = true), c.value && (a == null || a(W));
    }, C),
...
function vr(t, e, l, a = {}) {
  ...
  const {
    ...
    defaultValue: p,
    shouldEmit: f
  } = a, m = getCurrentInstance(), y = l || (m == null ? void 0 : m.emit) || ((o = m == null ? void 0 : m.$emit) == null ? void 0 : o.bind(m)) || ((n = (r = m == null ? void 0 : m.proxy) == null ? void 0 : r.$emit) == null ? void 0 : n.bind(m == null ? void 0 : m.proxy));
  let c = u;
  e || (e = "modelValue"), c = c || `update:${e.toString()}`;
  const g = (k) => s ? typeof s == "function" ? s(k) : Js(k) : k, v = () => Ls(t[e]) ? g(t[e]) : p, h2 = (k) => {
    f ? f(k) && y(c, k) : y(c, k);
  };
  if (i) {
    const k = v(), C = ref(k);
    ...
    return watch(
      () => t[e],
      (_) => {
        w || (w = true, C.value = g(_), nextTick(() => w = false));
      }
    ), watch(
      C,
      (_) => {
...
var Xa = defineComponent({
  ...
  setup(t, { expose: e, emit: l }) {
    const a = t, o = l, r = useModel(t, "modelValue"), n = ref(r.value), s = ref(r.value);
    watchEffect(() => {
      r.value = n.value;
    }), watch(r, (q) => {
      q !== n.value && (q ? A() : K(new Event("update:modelValue")));
    });
    const i = Be(() => a.id, "popover"), u = ref(false), d = ref(null), p = ref(null), f = ref(null), m = ref(null), y = ref(null), c = computed(
      () => a.title ? Tt(a.title, $t) : ""
    ), g = computed(
      () => a.content ? Tt(a.content, $t) : ""
    ), v = toRef(() => a.placement.startsWith("auto")), h2 = be(() => a.offset ?? NaN), k = computed(
      ...
      const q = a.offset !== null ? h2.value : a.tooltip ? 6 : 8, ne = [Kl(q)];
      return a.noFlip === false && !v.value && ne.push(
        so({
          boundary: k.value,
      ...
      ), a.inline === true && ne.push(Ts()), ne.push(_s({ element: f, padding: 10 })), a.noSize === false && ne.push(
        ro({
          boundary: k.value,
          rootBoundary: C.value,
          padding: a.boundaryPadding,
    ...
    }), R = ref({ position: "absolute" });
    watch(W, () => {
      var q;
      if (a.noHide === false && ((q = W.value.hide) != null && q.referenceHidden ? u.value = true : u.value = false), W.value.arrow) {
    ...
    let j;
    const A = () => {
      const q = M("show", { cancelable: true });
    ...
    return yo(
      ...
      ie(), G();
    }), onMounted(G), onBeforeUnmount(ie), (q, ne) => (openBlock(), createElementBlock(Fragment, null, [
      createBaseVNode("span", {
        id: unref(i) + "_placeholder",
        ref_key: "placeholder",
        ref: y
      }, null, 8, pr),
      renderSlot(q.$slots, "target", {
        show: A,
        hide: K,
        toggle: E,
        showState: n.value
      ...
      (openBlock(), createBlock(Teleport, {
        ...
        s.value || a.persistent ? (openBlock(), createElementBlock("div", mergeProps({
          key: 0,
          id: unref(i)
        }, q.$attrs, {
          ref_key: "element",
          ...
          createBaseVNode("div", {
            ref_key: "arrow",
            ref: f,
            class: normalizeClass(`${a.tooltip ? "tooltip" : "popover"}-arrow`),
          ...
          createBaseVNode("div", {
            ...
            q.title || q.$slots.title ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
              a.html ? (openBlock(), createElementBlock("div", {
                key: 1,
                class: normalizeClass(["position-sticky top-0", a.tooltip ? "tooltip-inner" : "popover-header"]),
                innerHTML: c.value
              }, null, 10, br)) : (openBlock(), createElementBlock("div", {
                key: 0,
                class: normalizeClass(["position-sticky top-0", a.tooltip ? "tooltip-inner" : "popover-header"])
              }, [
                renderSlot(q.$slots, "title", {}, () => [
                  createTextVNode(toDisplayString(q.title), 1)
                ])
              ], 2))
            ], 64)) : createCommentVNode("", true),
            a.tooltip && !q.$slots.title && !q.title || !a.tooltip ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [
              a.html ? (openBlock(), createElementBlock("div", {
                key: 1,
                class: normalizeClass(a.tooltip ? "tooltip-inner" : "popover-body"),
                innerHTML: g.value
              }, null, 10, yr)) : (openBlock(), createElementBlock("div", {
                key: 0,
                class: normalizeClass(a.tooltip ? "tooltip-inner" : "popover-body")
              }, [
                renderSlot(q.$slots, "default", {}, () => [
                  createTextVNode(toDisplayString(q.content), 1)
                ])
              ], 2))
            ], 64)) : createCommentVNode("", true)
          ], 4)
        ], 16, mr)) : createCommentVNode("", true)
      ], 8, ["to", "disabled"]))
    ], 64));
  }
});
...
var Ht = (t) => typeof t != "object" || t.active !== false;
var oa = (t, e) => {
  if (!Ht(t))
    return {};
...
var na = (t, e) => ({
  ...
  ...t.modifiers.interactive ? { noninteractive: false } : {},
  title: null,
  content: null
});
var sa = (t, e, l) => {
  ...
  e.modifiers.body ? document.body.appendChild(a) : e.modifiers.child ? t.appendChild(a) : (o = t.parentNode) == null || o.insertBefore(a, t.nextSibling), render(h(Xa, l), a), t.$__element = a;
};
var ra = (t) => {
  const e = t.$__element;
  e && render(null, e), setTimeout(() => {
    e == null || e.remove();
...
var fa = (t, e, l) => e.concat(["sm", "md", "lg", "xl", "xxl"]).reduce((a, o) => (a[t ? `${t}${o.charAt(0).toUpperCase() + o.slice(1)}` : o] = l, a), {});
var Bo = (t, e, l, a = l) => Object.keys(e).reduce((o, r) => (t[r] && o.push(
...
var Br = (t, e) => ((t == null ? void 0 : t()) ?? []).reduce((l, a) => (typeof a.type == "symbol" ? l = l.concat(a.children) : l.push(a), l), []).filter((l) => {
  var a;
...
var Sr = /[-/\\^$*+?.()|[\]{}]/g;
var Vr = /[\s\uFEFF\xA0]+/g;
var ya = (t) => t.replace(wo, " ").replace(Co, (e, l, a) => `${l} ${a}`).replace(kr, (e, l, a) => l + a.toUpperCase());
var hl = (t) => t.replace(wo, " ").replace(Co, (e, l, a) => `${l} ${a}`).replace(Cr, (e, l, a) => l + a.toUpperCase());
var _r = (t) => {
  const e = t.trim();
  return e.charAt(0).toUpperCase() + e.slice(1);
};
var Ar = (t) => t.replace(Sr, "\\$&");
var Or = (t) => Ar(t).replace(Vr, "\\s");
var Zt = (t) => typeof t == "string" ? hl(t) : t.label !== void 0 ? t.label : typeof t.key == "string" ? hl(t.key) : t.key;
var Nr = (t) => !!(t.href || t.to);
var ko = Symbol("carousel");
var $o = Symbol("tabs");
var To = Symbol("progress");
var So = Symbol("listGroup");
var Vo = Symbol("avatarGroup");
var _o = Symbol("accordion");
var Ao = Symbol("checkboxGroup");
var Oo = Symbol("radioGroup");
var Ka = Symbol("collapse");
var No = Symbol("collapse");
var Ya = Symbol("navbar");
var Io = Symbol("toastPlugin");
var Po = Symbol("rtlPlugin");
var Eo = Symbol("breadcrumbPlugin");
var Lo = Symbol("modalControllerPlugin");
var Fo = Symbol("modalManagerPlugin");
var zo = Symbol("idPluginKey");
var Et = (t, e = {}, l = {}) => {
  const a = [t];
  let o;
...
var va = (t, e) => Object.keys(t).filter((l) => !e.map((a) => a.toString()).includes(l)).reduce((l, a) => ({ ...l, [a]: t[a] }), {});
var Ja = (t, e) => [...e].reduce(
  (l, a) => (l[a] = t[a], l),
  {}
);
...
var wl = (t, e) => e + (t ? _r(t) : "");
var wt = (t, e) => {
  const l = toRef(e), a = toRef(t), o = toRef(() => Nr(a.value)), r = computed(
    () => o.value ? Ja(
      a.value,
      l.value ?? [
        "active",
...
var Ho = () => ({ ...inject(Eo) });
var Pr = (t = {}) => {
  const e = t.persist ?? false, l = "data-bs-theme", a = "body";
  return or({
    attribute: l,
    selector: a,
    storageKey: e === true ? `bv-color-${t.attribute ?? l}-${t.selector ?? a}` : null,
    ...t
  });
};
var Qe = (t) => computed(() => {
...
var Ro = (t, e = ref(1e3), l = {}) => {
  const a = readonly(toRef(t)), o = readonly(toRef(e)), r = ref(false), n = ref(0), s = toRef(() => Math.ceil(a.value / o.value)), i = toRef(
    ...
    r.value = false, n.value = 0, d();
  }, m = () => {
    r.value = false, n.value = s.value;
  };
  watchEffect(() => {
  ...
  const y = () => {
    p.value !== false && (r.value = true, u());
  }, c = () => {
    n.value !== s.value && (r.value = false, d());
  };
  return {
    isActive: readonly(p),
    isPaused: readonly(r),
...
var Ct = (t) => computed(() => {
  const e = toValue(t);
  return e === true ? "is-valid" : e === false ? "is-invalid" : null;
});
var Mo = (t) => computed(() => {
  const e = toValue(t);
  return {
    "form-check": e.plain === false && e.button === false && e.hasDefaultSlot,
    "form-check-reverse": e.reverse === true,
    "form-check-inline": e.inline === true,
    "form-switch": e.switch === true,
    [`form-control-${e.size}`]: e.size !== void 0 && e.size !== "md" && e.button === false
  };
});
var xo = (t) => {
  const e = toRef(t), l = Ct(() => e.value.state ?? null);
  return computed(() => [
    l.value,
    {
      "form-check-input": e.value.plain === false && e.value.button === false,
      "btn-check": e.value.button === true
    }
  ]);
};
var Do = (t) => computed(() => {
  ...
  return {
    ...
    btn: e.button === true,
    [`btn-${e.buttonVariant}`]: e.button === true && e.buttonVariant !== void 0 && e.buttonVariant !== null,
    [`btn-${e.size}`]: e.button && e.size && e.size !== "md"
  };
});
var jo = (t) => {
  const e = toRef(t), l = ua(
    () => e.value.ariaInvalid,
    () => e.value.state
  );
  return computed(() => ({
    "aria-invalid": l.value,
    "aria-required": e.value.required === true ? true : void 0
  }));
};
var qo = (t) => computed(() => {
  const e = toValue(t);
  return {
    ...
    "btn-group-vertical": e.stacked === true && e.buttons === true,
    [`btn-group-${e.size}`]: e.size !== void 0
  };
});
var Be = (t, e) => computed(() => toValue(t) || Lr(e));
var Lr = (t = "") => `__BVID__${inject(zo, () => Math.random().toString().slice(2, 8))()}___BV_${t}__`;
var Wo = (t, e) => {
  const l = ref(null), a = vr(t, "modelValue", e, { passive: true }), o = Be(() => t.id, "input"), r = be(() => t.debounce ?? 0), n = be(() => t.debounceMaxWait ?? NaN), s = Ws(
    (h2) => {
      a.value = h2;
    },
    () => t.lazy === true ? 0 : r.value,
    { maxWait: () => t.lazy === true ? NaN : n.value }
  ), i = (h2, k = false) => {
    t.lazy === true && k === false || s(h2);
  }, { focused: u } = Pe(l, {
    initialValue: t.autofocus
  }), d = (h2, k, C = false) => t.formatter !== void 0 && (!t.lazyFormatter || C) ? t.formatter(h2, k) : h2, p = (h2) => t.trim ? h2.trim() : t.number ? Number.parseFloat(h2) : h2;
  onMounted(() => {
    var h2;
    l.value && (l.value.value = ((h2 = a.value) == null ? void 0 : h2.toString()) ?? "");
  }), onActivated(() => {
    nextTick(() => {
      t.autofocus && (u.value = true);
    });
  });
  const f = ua(
    () => t.ariaInvalid,
  ...
  return {
    ...
    onInput: (h2) => {
      const { value: k } = h2.target, C = d(k, h2);
      if (h2.defaultPrevented) {
        h2.preventDefault();
        return;
      }
      const w = p(C);
    ...
    onBlur: (h2) => {
      if (!t.lazy && !t.lazyFormatter)
        return;
      const { value: k } = h2.target, C = d(k, h2, true), w = p(C);
      a.value !== w && i(C, true);
    },
    focus: () => {
      t.disabled || (u.value = true);
    },
    blur: () => {
      t.disabled || (u.value = false);
    }
  };
};
var Go = (t, e) => {
  ...
  return { normalizedOptions: computed(() => o(toValue(t))), isComplex: l };
};
var ga = "modal-open";
var Za = () => {
  const t = inject(Fo), e = (a) => {
...
var Fr = (t) => {
  const { pushRegistry: e, pushStack: l, removeStack: a, stack: o, dispose: r, countStack: n } = Za(), s = getCurrentInstance();
...
var zr = (t = void 0) => {
  const { registry: e } = Za(), l = getCurrentInstance(), a = (n) => n.parent ? n.parent.type.__name === "BModal" ? n.parent : a(n.parent) : null, o = computed(() => {
    const n = toValue(t);
  ...
  return onMounted(() => {
    watch(
      ...
      ([e, l]) => {
        ...
        a.setAttribute("dir", e ?? false ? "rtl" : "ltr"), a.setAttribute("lang", l ?? "");
      },
      { immediate: true }
    );
  }), { ...t };
...
var Xo = (t, e) => {
  const l = readonly(toRef(t)), a = readonly(toRef(e)), o = toRef(() => !a.value);
  onMounted(() => {
    const r = dr(
      document.body,
      l.value && o.value
...
var Ko = (t, e, l = {}) => {
  const a = toRef(t), o = toRef(e), r = ref(mt(a.value)), n = ref(mt(o.value));
  watch([a, o], () => {
    h2();
  });
  const {
  ...
  const w = computed(
    ...
    (L) => {
      ...
      k = J > C, C = J, L.forEach((M) => {
        if (M.isIntersecting) {
          c.value.forEach((j) => {
            j.el === M.target && (j.visible = true);
          });
          return;
        }
        c.value.forEach((j) => {
          j.el === M.target && (j.visible = false);
        });
      });
      let R = null;
  ...
  watch(y, (L) => {
    ...
    J.forEach((S) => {
      ...
      if ((M = S.getAttribute("href")) != null && M.includes(`#${L}`)) {
        le = S, S.classList.add("active"), E && ((j = E == null ? void 0 : E.querySelector(".dropdown-toggle")) == null || j.classList.add("active"), R = true);
        let ee = (A = S.closest(".nav")) == null ? void 0 : A.previousSibling;
        for (; (K = ee == null ? void 0 : ee.classList) != null && K.contains("nav-item"); )
          R = true, (G = ee.querySelector(".nav-link")) == null || G.classList.add("active"), ee = (ie = ee.closest(".nav")) == null ? void 0 : ie.previousSibling;
        ...
        for (; (ge = ee == null ? void 0 : ee.classList) != null && ge.contains("nav-item"); )
          R = true, ee.querySelector(".nav-link") !== le && ((te = ee.querySelector(".nav-link")) == null || te.classList.remove("active")), ee = (ye = ee.closest(".nav")) == null ? void 0 : ye.previousSibling;
      }
    });
  });
  const F = m ? nr(
...
var It = defineComponent({
  ...
  setup(t, { emit: e }) {
    const l = t, a = e, o = computed(() => {
      ...
      return l.noFade ? n : s;
    }), r = computed(() => ({ mode: l.mode, css: true, ...o.value }));
    return (n, s) => (openBlock(), createBlock(Transition, mergeProps({ ...r.value, ...n.transProps }, {
      appear: l.appear,
...
var Rr = ["type", "disabled", "aria-label"];
var Pt = defineComponent({
  ...
  setup(t, { emit: e }) {
    const l = t, a = e;
    return (o, r) => (openBlock(), createElementBlock("button", {
      type: o.type,
      class: "btn-close",
      disabled: l.disabled,
...
var lt = defineComponent({
  ...
  emits: ["click"],
  setup(t, { emit: e }) {
    const l = t, a = e, o = useAttrs(), r = inject(Ka, null), n = inject(Ya, null), s = getCurrentInstance(), i = computed(() => {
      ...
      if (c !== void 0 && "path" in c) {
        ...
        }).join("=")}` : "", h2 = !c.hash || c.hash.charAt(0) === "#" ? c.hash || "" : `#${c.hash}`;
        return `${g}${v}${h2}` || y;
      }
      return y;
    }), d = computed(() => ({
      ...
      "aria-disabled": l.disabled ? true : null
    })), f = computed(() => ({
      [Cl]: l.active,
      disabled: l.disabled
    })), m = (y) => {
      ...
      (((c = r == null ? void 0 : r.isNav) == null ? void 0 : c.value) === true && n === null || n !== null && ((g = n.autoClose) == null ? void 0 : g.value) === true) && ((v = r == null ? void 0 : r.hide) == null || v.call(r)), a("click", y);
    };
    return (y, c) => i.value === "router-link" ? (openBlock(), createBlock(resolveDynamicComponent(i.value), mergeProps({ key: 0 }, p.value, { custom: "" }), {
      default: withCtx(({ href: g, navigate: v, isActive: h2, isExactActive: k }) => [
        (openBlock(), createBlock(resolveDynamicComponent(y.routerTag), mergeProps({
          href: g,
          class: {
            [Cl]: l.active,
            [y.activeClass]: h2,
      ...
      _: 3
    }, 16)) : (openBlock(), createBlock(resolveDynamicComponent(i.value), mergeProps({
      key: 1,
      class: f.value
    }, p.value, { onClick: m }), {
      default: withCtx(() => [
...
var Mr = ["aria-valuenow", "aria-valuemax"];
var Jo = defineComponent({
  ...
  setup(t) {
    const e = t, l = inject(To, null), a = Qe(e), o = computed(() => [
      a.value,
      {
    ...
    ]), r = be(() => e.precision), n = be(() => e.value), s = be(() => e.max ?? NaN), i = be(() => (l == null ? void 0 : l.max.value) ?? NaN), u = computed(
    ...
    return (p, f) => (openBlock(), createElementBlock("div", {
      class: normalizeClass(["progress-bar", o.value]),
      role: "progressbar",
      "aria-valuenow": p.value,
      "aria-valuemin": "0",
      "aria-valuemax": p.max,
      style: normalizeStyle({ width: d.value })
    }, [
...
var Zo = defineComponent({
  ...
  setup(t) {
    ...
    }), (l, a) => (openBlock(), createElementBlock("div", {
      class: "progress",
      style: normalizeStyle({ height: l.height })
    }, [
...
var xr = ["id", "role", "aria-live", "aria-atomic"];
var Dr = { class: "me-auto" };
var Qo = defineComponent({
  ...
  setup(t, { expose: e, emit: l }) {
    const a = t, o = l, r = ref(null), n = Ua(r), s = useModel(t, "modelValue"), { computedLink: i, computedLinkProps: u } = wt(a), d = be(() => a.interval), p = Qe(a), f = toRef(() => typeof s.value == "boolean" ? 0 : s.value), {
      isActive: m,
      pause: y,
      restart: c,
      resume: g,
    ...
    const C = toRef(() => i.value ? lt : "div"), w = toRef(
      () => typeof s.value == "boolean" ? s.value : m.value || a.showOnPause && h2.value
    ), _ = computed(() => [
      p.value,
      {
        show: w.value
    ...
    const Q = (N, S = {}) => new Bt(N, {
      ...
      const N = Q("show", { cancelable: true });
      if (o("show", N), N.defaultPrevented) {
        s.value && (s.value = false), o("show-prevented");
        return;
      }
      ...
      if (o("hide", S), N === "close" && o("close", S), S.defaultPrevented) {
        o("hide-prevented"), s.value || (s.value = true);
        return;
      }
      typeof s.value == "boolean" ? s.value = false : (s.value = 0, v());
    }, J = () => {
      W();
    }, R = () => {
      o("shown", Q("shown"));
    ...
    return watch(m, (N) => {
      N === false && h2.value === false && s.value && L();
    }), onBeforeUnmount(v), e({
      pause: y,
      restart: c,
      resume: g,
      stop: v
    }), (N, S) => (openBlock(), createBlock(It, mergeProps({
      "no-fade": a.noFade
    }, N.transProps, {
      onBeforeEnter: J,
      onAfterEnter: R,
      ...
      default: withCtx(() => [
        w.value ? (openBlock(), createElementBlock("div", {
          ...
          ref_key: "element",
          ref: r,
          class: normalizeClass(["toast", [N.toastClass, _.value]]),
          tabindex: "0",
          role: w.value ? a.isStatus ? "status" : "alert" : void 0,
          "aria-live": w.value ? a.isStatus ? "polite" : "assertive" : void 0,
          "aria-atomic": w.value ? true : void 0
        }, [
          N.$slots.title || N.title ? (openBlock(), createBlock(resolveDynamicComponent(N.headerTag), {
            key: 0,
            class: "toast-header"
          }, {
            default: withCtx(() => [
              renderSlot(N.$slots, "title", { hide: L }, () => [
                createBaseVNode("strong", Dr, toDisplayString(N.title), 1)
              ]),
              a.noCloseButton ? createCommentVNode("", true) : (openBlock(), createBlock(Pt, {
                key: 0,
          ...
          N.$slots.default || N.body ? (openBlock(), createBlock(resolveDynamicComponent(C.value), mergeProps({
            key: 1,
            class: ["toast-body", N.bodyClass],
            style: { display: "block" }
          }, unref(u), {
            onClick: S[1] || (S[1] = (E) => unref(i) ? L() : () => {
            })
          }), {
            default: withCtx(() => [
              renderSlot(N.$slots, "default", { hide: L }, () => [
                createTextVNode(toDisplayString(N.body), 1)
              ])
            ]),
            _: 3
          }, 16, ["class"])) : createCommentVNode("", true),
          typeof s.value == "number" && N.progressProps !== void 0 ? (openBlock(), createBlock(Zo, {
            key: 2,
...
var qr = {
  install(t) {
    const e = shallowRef([]), l = ref(false), a = (n) => {
      l.value = n;
    }, o = (n) => {
      const s = Symbol(), i = computed(() => {
        const u = toValue(n.props);
        return {
          component: toValue(n.component) ?? Qo,
          props: {
            ...u,
...
var pa = defineComponent({
  ...
  setup(t) {
    const e = t, l = useSlots(), a = computed(() => [
      `spinner-${e.type}`,
      {
    ...
    return (r, n) => (openBlock(), createBlock(resolveDynamicComponent(r.tag), {
      class: normalizeClass(a.value),
      role: r.label || o.value ? r.role : null,
      "aria-hidden": r.label || o.value ? null : true
    }, {
      default: withCtx(() => [
        r.label || o.value ? (openBlock(), createElementBlock("span", Ur, [
...
var vt = defineComponent({
  ...
  setup(t, { emit: e }) {
    const l = t, a = e, o = useModel(t, "pressed"), { computedLink: r, computedLinkProps: n } = wt(l, [
      "active-class",
      "exact-active-class",
      "replace",
      "routerComponentName",
      "routerTag"
    ]), s = toRef(() => typeof l.pressed == "boolean"), i = toRef(
      () => l.tag === "button" && l.href === void 0 && l.to === void 0
    ), u = toRef(() => l.to !== void 0), d = toRef(() => l.href !== void 0 ? false : !i.value), p = computed(() => u.value ? n.value : []), f = computed(() => [
      [`btn-${l.size}`],
      {
    ...
    ]), m = toRef(() => u.value ? lt : l.href ? "a" : l.tag), y = (c) => {
      if (l.disabled) {
    ...
    return (c, g) => (openBlock(), createBlock(resolveDynamicComponent(m.value), mergeProps({ class: "btn" }, p.value, {
      class: f.value,
      ...
      href: c.href,
      rel: unref(r) ? c.rel : null,
      role: d.value || unref(r) ? "button" : null,
      target: unref(r) ? c.target : null,
      type: i.value ? c.type : null,
      to: i.value ? null : c.to,
      append: unref(r) ? c.append : null,
      onClick: y
    }), {
      default: withCtx(() => [
        l.loading ? renderSlot(c.$slots, "loading", { key: 0 }, () => [
          l.loadingFill ? createCommentVNode("", true) : (openBlock(), createElementBlock(Fragment, { key: 0 }, [
            createTextVNode(toDisplayString(c.loadingText), 1)
          ], 64)),
          renderSlot(c.$slots, "loading-spinner", {}, () => [
            createVNode(pa, {
              small: c.size !== "lg",
              label: l.loadingFill ? c.loadingText : void 0
            }, null, 8, ["small", "label"])
          ])
        ]) : renderSlot(c.$slots, "default", { key: 1 })
      ]),
      _: 3
...
var ma = defineComponent({
  ...
  setup(t, { emit: e }) {
    ...
    ), s = toRef(() => l.show ? true : null), i = computed(() => ({
      type: l.spinnerType,
    ...
    })), p = computed(() => [n.value, r.value]), f = computed(() => ({
      ...o,
      opacity: l.opacity,
    ...
    return (y, c) => (openBlock(), createBlock(resolveDynamicComponent(y.wrapTag), {
      ...
      default: withCtx(() => [
        ...
        createVNode(It, {
          ...
          default: withCtx(() => [
            l.show ? (openBlock(), createBlock(resolveDynamicComponent(y.overlayTag), {
              key: 0,
              class: normalizeClass(["b-overlay", d.value]),
              ...
              default: withCtx(() => [
                ...
                createBaseVNode("div", {
                  ...
                  renderSlot(y.$slots, "overlay", normalizeProps(guardReactiveProps(i.value)), () => [
                    l.noSpinner ? createCommentVNode("", true) : (openBlock(), createBlock(pa, normalizeProps(mergeProps({ key: 0 }, i.value)), null, 16))
                  ])
                ], 4)
              ]),
              _: 3
...
var Xr = ["id", "aria-labelledby", "aria-describedby"];
var Kr = ["id"];
var kl = 1056;
var Yr = defineComponent({
  ...
  setup(t, { expose: e, emit: l }) {
    const a = t, o = l, r = useSlots(), n = Be(() => a.id, "modal"), s = useModel(t, "modelValue"), i = ref(null), u = ref(null), d = ref(null), p = ref(null), f = ref(s.value), m = ref(false);
    Re(
      "Escape",
      () => {
        j("esc");
    ...
    const { focused: y } = Pe(i, {
      ...
      () => a.lazy === false || a.lazy === true && m.value === true || a.lazy === true && s.value === true
    ), C = toRef(
      () => a.backdropVariant !== void 0 ? a.backdropVariant : a.hideBackdrop ? "transparent" : "dark"
    ), w = toRef(() => !Ae(r["header-close"])), _ = computed(() => [
      a.dialogClass,
      {
    ...
    })), Q = computed(() => [a.bodyClass, F.value]), W = Qe(() => ({
    ...
    ]), S = toRef(() => a.cancelDisabled || a.busy), E = toRef(() => a.okDisabled || a.busy), M = (U, z = {}) => new Bt(U, {
      cancelable: false,
      target: i.value || null,
      relatedTarget: null,
      trigger: null,
    ...
    const j = (U = "") => {
      ...
      if (f.value)
        return;
      const U = M("show", { cancelable: true });
      ...
      a.autoFocus !== false && (a.autoFocusButton === "ok" ? c.value = true : a.autoFocusButton === "close" ? v.value = true : a.autoFocusButton === "cancel" ? g.value = true : y.value = true);
    }, G = () => {
      A();
    }, ie = () => {
      f.value = true, K(), o("shown", M("shown")), a.lazy === true && (m.value = true);
    }, q = () => {
      f.value = false;
    }, ne = () => {
      o("hidden", M("hidden")), a.lazy === true && (m.value = false);
    }, { activePosition: ge, activeModalCount: te } = Fr(f), ye = computed(() => ({
    ...
    return e({
      ...
      return openBlock(), createBlock(Teleport, {
        ...
        createVNode(It, mergeProps({ "no-fade": true }, U.transProps, {
          ...
          default: withCtx(() => [
            withDirectives(createBaseVNode("div", mergeProps({
              ...
              ref_key: "element",
              ref: i,
              class: ["modal", h2.value],
              role: "dialog",
              "aria-labelledby": a.hideHeader ? void 0 : `${unref(n)}-label`,
              "aria-describedby": `${unref(n)}-body`,
              tabindex: "-1"
            }, U.$attrs, { style: ye.value }), [
              createBaseVNode("div", {
                class: normalizeClass(["modal-dialog", _.value])
              }, [
                k.value ? (openBlock(), createElementBlock("div", {
                  key: 0,
                  class: normalizeClass(["modal-content", U.contentClass])
                }, [
                  a.hideHeader ? createCommentVNode("", true) : (openBlock(), createElementBlock("div", {
                    key: 0,
                    class: normalizeClass(["modal-header", L.value])
                  }, [
                    renderSlot(U.$slots, "header", normalizeProps(guardReactiveProps(ee.value)), () => [
                      (openBlock(), createBlock(resolveDynamicComponent(U.titleTag), {
                        id: `${unref(n)}-label`,
                        class: normalizeClass(["modal-title", N.value])
                      }, {
                        default: withCtx(() => [
                          renderSlot(U.$slots, "title", normalizeProps(guardReactiveProps(ee.value)), () => [
                            createTextVNode(toDisplayString(U.title), 1)
                          ], true)
                        ]),
                        _: 3
                      }, 8, ["id", "class"])),
                      a.hideHeaderClose ? createCommentVNode("", true) : (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                        w.value ? (openBlock(), createBlock(vt, mergeProps({ key: 0 }, J.value, {
                          onClick: z[0] || (z[0] = (fe) => j("close"))
                        }), {
                          default: withCtx(() => [
                            renderSlot(U.$slots, "header-close", {}, void 0, true)
                          ]),
                          _: 3
                        }, 16)) : (openBlock(), createBlock(Pt, mergeProps({
                          key: 1,
                  ...
                  createBaseVNode("div", mergeProps({
                    ...
                    renderSlot(U.$slots, "default", normalizeProps(guardReactiveProps(ee.value)), () => [
                      createTextVNode(toDisplayString(U.body), 1)
                    ], true)
                  ], 16, Kr),
                  a.hideFooter ? createCommentVNode("", true) : (openBlock(), createElementBlock("div", {
                    key: 1,
                    class: normalizeClass(["modal-footer", le.value])
                  }, [
                    renderSlot(U.$slots, "footer", normalizeProps(guardReactiveProps(ee.value)), () => [
                      renderSlot(U.$slots, "cancel", normalizeProps(guardReactiveProps(ee.value)), () => [
                        a.okOnly ? createCommentVNode("", true) : (openBlock(), createBlock(vt, {
                          key: 0,
                          ...
                          default: withCtx(() => [
                            createTextVNode(toDisplayString(U.cancelTitle), 1)
                          ]),
                          _: 1
                        }, 8, ["disabled", "size", "variant"]))
                      ], true),
                      renderSlot(U.$slots, "ok", normalizeProps(guardReactiveProps(ee.value)), () => [
                        createVNode(vt, {
                          ref_key: "okButton",
                          ref: u,
                          disabled: E.value,
                          ...
                          default: withCtx(() => [
                            createTextVNode(toDisplayString(U.okTitle), 1)
                          ]),
                          _: 1
                        }, 8, ["disabled", "size", "variant"])
                      ], true)
...
var Va = qt(Yr, [["__scopeId", "data-v-8a2b2b28"]]);
var Jr = {
  install(t) {
    const e = shallowRef([]), l = () => {
      let n = () => {
      };
      return {
        value: new Promise((i) => {
      ...
      return e.value = [
        ...e.value,
        computed(() => ({
          component: toValue(n.component) ?? Va,
          props: { ...toValue(n.props), _isConfirm: false, _promise: s, _self: i, _modelValue: true }
        }))
      ], s.value;
    }, o = (n) => {
      const s = l(), i = Symbol();
      return e.value = [
        ...
        computed(() => ({
          component: toValue(n.component) ?? Va,
          props: { ...toValue(n.props), _isConfirm: true, _promise: s, _self: i, _modelValue: true }
        }))
      ], s.value;
    }, r = (n) => {
      e.value = e.value.filter((s) => s.value.props._self !== n);
...
var Zr = {
  install(t) {
    const e = shallowRef([]), l = toRef(() => e.value.length), a = toRef(() => e.value[e.value.length - 1]), o = (u) => {
      e.value = [...e.value, u];
    }, r = (u) => {
...
var Qr = {
  install(t, e) {
    var i, u;
    const o = typeof (e == null ? void 0 : e.rtl) == "boolean" ? false : ((i = e == null ? void 0 : e.rtl) == null ? void 0 : i.rtlInitial) ?? false, r = typeof (e == null ? void 0 : e.rtl) == "boolean" ? void 0 : ((u = e == null ? void 0 : e.rtl) == null ? void 0 : u.localeInitial) ?? void 0, n = ref(o), s = ref(r);
...
var ti = defineComponent({
  ...
  setup(t) {
    const e = t, l = useModel(t, "modelValue"), a = Be(() => e.id, "accordion"), o = computed(() => ({
    ...
    return provide(_o, {
      ...
      id: unref(a),
      class: normalizeClass(["accordion", o.value])
    }, [
...
var en = defineComponent({
  ...
  setup(t, { expose: e, emit: l }) {
    const a = t, o = l, r = (w, _ = {}) => new Bt(w, {
      ...
      ..._,
      componentId: s.value
    }), n = useModel(t, "modelValue"), s = Be(() => a.id, "collapse"), i = ref(null), u = ref(false), d = ref(n.value), p = computed(() => ({
      show: d.value,
    ...
    let g, v, h2 = a.skipAnimation;
    const k = () => {
      const w = r("show", { cancelable: true });
      if (o("show", w), w.defaultPrevented) {
        o("show-prevented");
        return;
      }
      clearTimeout(v), clearTimeout(g), d.value = true, !h2 && (u.value = true, nextTick(() => {
        i.value !== null && (a.horizontal ? i.value.style.width = `${i.value.scrollWidth}px` : i.value.style.height = `${i.value.scrollHeight}px`, g = setTimeout(() => {
          u.value = false, o("shown"), i.value !== null && (i.value.style.height = "", i.value.style.width = "");
        }, wa(i.value)));
      }));
    }, C = () => {
      const w = r("hide", { cancelable: true });
      ...
      if (clearTimeout(g), clearTimeout(v), i.value !== null) {
        ...
        u.value ? (i.value.style.height = "", i.value.style.width = "") : a.horizontal ? i.value.style.width = `${i.value.scrollWidth}px` : i.value.style.height = `${i.value.scrollHeight}px`, i.value.offsetHeight, u.value = true, nextTick(() => {
          i.value !== null && (i.value.style.height = "", i.value.style.width = "", v = setTimeout(() => {
            d.value = false, u.value = false, o("hidden");
          }, wa(i.value)));
        });
      }
    };
    return watch(n, () => {
      ...
      i.value !== null && !n.value && a.toggle && nextTick(() => {
        n.value = true;
      });
    }), watch(
      () => a.skipAnimation,
    ...
    ), a.visible && (h2 = true, n.value = true, nextTick(() => {
      h2 = a.skipAnimation;
    })), watch(
      () => a.visible,
      (w) => {
        h2 = true, w ? m() : f(), nextTick(() => {
          h2 = a.skipAnimation;
        });
      }
    ), ke(i, "bv-toggle", () => {
      ...
      visible: readonly(d),
      isNav: toRef(() => a.isNav)
    }), (w, _) => (openBlock(), createElementBlock(Fragment, null, [
      renderSlot(w.$slots, "header", normalizeProps(guardReactiveProps(c.value))),
      (openBlock(), createBlock(resolveDynamicComponent(w.tag), mergeProps({
        id: unref(s),
        ref_key: "element",
        ref: i,
        ...
        default: withCtx(() => [
          renderSlot(w.$slots, "default", normalizeProps(guardReactiveProps(c.value)))
        ]),
        _: 3
      }, 16, ["id", "class", "is-nav"])),
      renderSlot(w.$slots, "footer", normalizeProps(guardReactiveProps(c.value)))
    ], 64));
  }
});
var ai = ["aria-expanded", "aria-controls", "onClick"];
var li = defineComponent({
  ...
  emits: mergeModels(["hidden", "hide", "hide-prevented", "show", "show-prevented", "shown"], ["update:modelValue"]),
  setup(t, { emit: e }) {
    const { class: l, ...a } = useAttrs(), o = t, r = e, n = useModel(t, "modelValue"), s = inject(_o, null), i = Be(() => o.id, "accordion_item");
    return onMounted(() => {
      n.value && !(s != null && s.free.value) && (s == null || s.setOpenItem(i.value)), !n.value && (s == null ? void 0 : s.openItem.value) === i.value && (n.value = true);
    }), watch(
    ...
    }), (u, d) => (openBlock(), createElementBlock("div", mergeProps({ class: "accordion-item" }, u.wrapperAttrs, { class: unref(l) }), [
      createVNode(en, mergeProps({
        id: unref(i),
        modelValue: n.value,
        ...
        header: withCtx(({ visible: p, toggle: f }) => [
...
var oi = defineComponent({
  ...
  setup(t, { expose: e, emit: l }) {
    const a = t, o = l, r = useSlots(), n = ref(null), s = useModel(t, "modelValue"), i = Ua(n), u = be(() => a.interval), d = toRef(() => !Ae(r.close)), p = toRef(() => typeof s.value == "boolean" ? 0 : s.value), f = computed(() => ({
      [`alert-${a.variant}`]: a.variant !== null,
      "alert-dismissible": a.dismissible
    })), m = computed(() => [a.closeClass, { "btn-close-custom": d.value }]), {
      isActive: y,
      pause: c,
      restart: g,
      resume: v,
    ...
    const F = () => {
      o("close"), typeof s.value == "boolean" ? s.value = false : (s.value = 0, h2()), o("closed");
    }, Q = () => {
      a.noHoverPause || c();
    };
    return watch(i, (W) => {
      ...
      v();
    }), onBeforeUnmount(h2), e({
      pause: c,
      restart: g,
      resume: v,
      stop: h2
    }), (W, L) => (openBlock(), createBlock(It, {
      "no-fade": !a.fade,
      "trans-props": { enterToClass: "show" }
    }, {
      default: withCtx(() => [
        w.value ? (openBlock(), createElementBlock("div", {
          ...
          a.dismissible ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
            d.value || W.closeContent ? (openBlock(), createBlock(vt, mergeProps({ key: 0 }, _.value, { onClick: F }), {
              default: withCtx(() => [
                renderSlot(W.$slots, "close", {}, () => [
                  createTextVNode(toDisplayString(W.closeContent), 1)
                ], true)
              ]),
              _: 3
            }, 16)) : (openBlock(), createBlock(Pt, mergeProps({
...
var ni = qt(oi, [["__scopeId", "data-v-30d91aa1"]]);
var si = {
  key: 0,
...
var ui = defineComponent({
  ...
  props: {
    ...
    badgeStart: { type: Boolean, default: false },
  ...
  setup(t, { emit: e }) {
    const l = t, a = e, o = useSlots(), { computedLink: r, computedLinkProps: n } = wt(l), s = inject(Vo, null), i = ["sm", null, "lg"], u = $l * 0.7, d = toRef(() => !Ae(o.default)), p = toRef(() => !Ae(o.badge)), f = toRef(() => !!l.badge || l.badge === "" || p.value), m = toRef(() => (s == null ? void 0 : s.size.value) ?? l.square), y = ia(() => l.size), c = ia(() => s == null ? void 0 : s.size.value), g = computed(() => c.value ?? y.value), v = toRef(() => (s == null ? void 0 : s.variant.value) ?? l.variant), h2 = toRef(() => (s == null ? void 0 : s.rounded.value) ?? l.rounded), k = toRef(() => (s == null ? void 0 : s.roundedTop.value) ?? l.roundedTop), C = toRef(() => (s == null ? void 0 : s.roundedBottom.value) ?? l.roundedBottom), w = toRef(() => (s == null ? void 0 : s.roundedStart.value) ?? l.roundedStart), _ = toRef(() => (s == null ? void 0 : s.roundedEnd.value) ?? l.roundedEnd), F = Qa(() => ({
      rounded: h2.value,
      roundedTop: k.value,
    ...
    })), W = toRef(() => l.badge === true ? "" : l.badge), L = toRef(() => (s == null ? void 0 : s.textVariant.value) ?? l.textVariant), J = toRef(() => (s == null ? void 0 : s.bgVariant.value) ?? l.bgVariant), R = Qe(() => ({
      bgVariant: J.value,
      textVariant: L.value,
      variant: v.value
    })), le = computed(() => [
    ...
    }), M = toRef(() => r.value ? lt : l.button ? "button" : "span"), j = computed(() => ({
      ...E.value,
    ...
    return (G, ie) => (openBlock(), createBlock(resolveDynamicComponent(M.value), mergeProps({
      class: ["b-avatar", le.value],
      style: j.value
    }, unref(n), {
      type: l.button && !unref(r) ? l.buttonType : void 0,
      disabled: l.disabled || null,
      onClick: A
    }), {
      default: withCtx(() => [
        d.value ? (openBlock(), createElementBlock("span", si, [
          renderSlot(G.$slots, "default")
        ])) : G.src ? (openBlock(), createElementBlock("span", ri, [
          createBaseVNode("img", {
            src: G.src,
            alt: G.alt,
            onError: K
          }, null, 40, ii)
        ])) : G.text ? (openBlock(), createElementBlock("span", {
          key: 2,
          class: "b-avatar-text",
          style: normalizeStyle(S.value)
        }, toDisplayString(G.text), 5)) : createCommentVNode("", true),
        f.value ? (openBlock(), createElementBlock("span", {
          key: 3,
          class: normalizeClass(["b-avatar-badge", unref(Q)]),
          style: normalizeStyle(N.value)
        }, [
          renderSlot(G.$slots, "badge", {}, () => [
...
var di = defineComponent({
  ...
  setup(t) {
    const e = t, l = be(() => e.overlap), a = ia(() => e.size), o = toRef(() => Math.min(Math.max(l.value, 0), 1) / 2), r = computed(() => {
    ...
    }), (n, s) => (openBlock(), createBlock(resolveDynamicComponent(n.tag), {
...
var ci = defineComponent({
  ...
  setup(t) {
    const e = t, l = Qe(e), { computedLink: a, computedLinkProps: o } = wt(e, [
      ...
      "underlineOpacityHover",
      "icon"
    ]), r = toRef(() => a.value ? lt : e.tag), n = computed(() => [
      l.value,
      {
        active: e.active,
        disabled: e.disabled,
    ...
    return (s, i) => (openBlock(), createBlock(resolveDynamicComponent(r.value), mergeProps({
      class: ["badge", n.value]
    }, unref(o)), {
      default: withCtx(() => [
...
var tn = defineComponent({
  ...
  setup(t, { emit: e }) {
    const l = t, a = e, o = computed(() => ({
      active: l.active
    })), r = toRef(() => l.active ? "span" : lt), n = toRef(() => l.active ? l.ariaCurrent : void 0), s = computed(
      () => r.value !== "span" ? Ja(l, [
        "active",
        "activeClass",
        "append",
    ...
    return (u, d) => (openBlock(), createElementBlock("li", {
      class: normalizeClass(["breadcrumb-item", o.value])
    }, [
      (openBlock(), createBlock(resolveDynamicComponent(r.value), mergeProps({ "aria-current": n.value }, s.value, { onClick: i }), {
        default: withCtx(() => [
          renderSlot(u.$slots, "default", {}, () => [
...
var fi = { "aria-label": "breadcrumb" };
var vi = { class: "breadcrumb" };
var pi = defineComponent({
  ...
  setup(t) {
    const e = t, l = Ho(), a = computed(() => {
      var s;
      const o = e.items || ((s = l.items) == null ? void 0 : s.value) || [];
      let r = false;
      return o.map((i, u) => (typeof i == "string" && (i = { text: i }, u < o.length - 1 && (i.href = "#")), i.active && (r = true), !i.active && !r && (i.active = u + 1 === o.length), i));
    });
    return (o, r) => (openBlock(), createElementBlock("nav", fi, [
      createBaseVNode("ol", vi, [
        renderSlot(o.$slots, "prepend"),
        (openBlock(true), createElementBlock(Fragment, null, renderList(a.value, (n, s) => (openBlock(), createBlock(tn, mergeProps({ key: s }, n), {
          default: withCtx(() => [
...
var yi = defineComponent({
  ...
  setup(t) {
    ...
    return (a, o) => (openBlock(), createElementBlock("div", {
      class: normalizeClass([l.value, "btn-toolbar"]),
      role: a.role,
      "aria-label": a.ariaLabel
    }, [
      renderSlot(a.$slots, "default")
...
var gi = ["src", "width", "height", "srcset", "sizes", "loading"];
var el = defineComponent({
  ...
  setup(t) {
    ...
    return (f, m) => (openBlock(), createElementBlock("img", {
...
var tl = defineComponent({
  ...
  setup(t) {
    ...
    ), a = computed(() => va(e, ["bottom", "top", "end", "start"]));
    return (o, r) => (openBlock(), createBlock(el, mergeProps(a.value, { class: l.value }), null, 16, ["class"]));
  }
});
var hi = ["innerHTML"];
var an = defineComponent({
  ...
  setup(t) {
    const e = t, l = Qe(e), a = computed(() => [
      l.value,
      {
        [`border-${e.borderVariant}`]: e.borderVariant !== null
      }
    ]);
    return (o, r) => (openBlock(), createBlock(resolveDynamicComponent(o.tag), {
      class: normalizeClass(a.value)
    }, {
      default: withCtx(() => [
        o.html ? (openBlock(), createElementBlock("div", {
          key: 0,
          innerHTML: o.html
        }, null, 8, hi)) : renderSlot(o.$slots, "default", { key: 1 }, () => [
...
var ln = defineComponent({
  ...
  setup(t) {
    const e = t;
    return (l, a) => (openBlock(), createBlock(an, mergeProps({ class: "card-header" }, e), {
      default: withCtx(() => [
        renderSlot(l.$slots, "default")
      ]),
      _: 3
...
var on = defineComponent({
  ...
  setup(t) {
    return (e, l) => (openBlock(), createBlock(resolveDynamicComponent(e.tag), { class: "card-title" }, {
      default: withCtx(() => [
...
var sn = defineComponent({
  ...
  setup(t) {
    const e = t, l = useSlots(), a = Qe(e), o = toRef(() => !Ae(l.title)), r = toRef(() => !Ae(l.subtitle)), n = computed(() => [
      a.value,
      {
    ...
    return (s, i) => (openBlock(), createBlock(resolveDynamicComponent(s.tag), {
      class: normalizeClass(["card-body", n.value])
    }, {
      default: withCtx(() => [
        s.title || o.value ? (openBlock(), createBlock(on, {
          key: 0,
          tag: s.titleTag
        }, {
          default: withCtx(() => [
        ...
        s.subtitle || r.value ? (openBlock(), createBlock(nn, {
          key: 1,
          tag: s.subtitleTag,
...
var rn = defineComponent({
  ...
  setup(t) {
    const e = t;
    return (l, a) => (openBlock(), createBlock(an, mergeProps({ class: "card-footer" }, e), {
      default: withCtx(() => [
        renderSlot(l.$slots, "default", {}, () => [
...
var un = defineComponent({
  ...
  setup(t) {
    const e = t, l = useSlots(), a = toRef(() => !Ae(l.header)), o = toRef(() => !Ae(l.footer)), r = Qe(e), n = computed(() => [
      r.value,
      {
    ...
    return (u, d) => (openBlock(), createBlock(resolveDynamicComponent(u.tag), {
      class: normalizeClass(["card", n.value])
    }, {
      default: withCtx(() => [
        createVNode(unref(i).define, null, {
          default: withCtx(() => [
            renderSlot(u.$slots, "img", {}, () => [
              u.imgSrc ? (openBlock(), createBlock(tl, normalizeProps(mergeProps({ key: 0 }, s.value)), null, 16)) : createCommentVNode("", true)
            ])
          ]),
          _: 3
        }),
        e.imgBottom ? createCommentVNode("", true) : (openBlock(), createBlock(unref(i).reuse, { key: 0 })),
        u.header || a.value || u.headerHtml ? (openBlock(), createBlock(ln, {
          key: 1,
          ...
          class: normalizeClass(u.headerClass)
        }, {
          default: withCtx(() => [
            renderSlot(u.$slots, "header", {}, () => [
              createTextVNode(toDisplayString(u.header), 1)
            ])
          ]),
          _: 3
        }, 8, ["bg-variant", "variant", "border-variant", "html", "tag", "text-variant", "class"])) : createCommentVNode("", true),
        e.noBody ? renderSlot(u.$slots, "default", { key: 3 }, () => [
          createTextVNode(toDisplayString(u.bodyText), 1)
        ]) : (openBlock(), createBlock(sn, {
          key: 2,
          overlay: u.overlay,
          ...
          class: normalizeClass(u.bodyClass)
        }, {
          default: withCtx(() => [
            renderSlot(u.$slots, "default", {}, () => [
              createTextVNode(toDisplayString(u.bodyText), 1)
        ...
        u.footer || o.value || u.footerHtml ? (openBlock(), createBlock(rn, {
          key: 4,
          ...
          class: normalizeClass(u.footerClass)
        }, {
          default: withCtx(() => [
            renderSlot(u.$slots, "footer", {}, () => [
              createTextVNode(toDisplayString(u.footer), 1)
            ])
          ]),
          _: 3
        }, 8, ["bg-variant", "border-variant", "variant", "html", "tag", "text-variant", "class"])) : createCommentVNode("", true),
        e.imgBottom ? (openBlock(), createBlock(unref(i).reuse, { key: 5 })) : createCommentVNode("", true)
      ]),
      _: 3
    }, 8, ["class"]));
  }
...
var wi = defineComponent({
  ...
  setup(t) {
    return (e, l) => (openBlock(), createBlock(resolveDynamicComponent(e.tag), { class: "card-text" }, {
      default: withCtx(() => [
        renderSlot(e.$slots, "default", {}, () => [
          createTextVNode(toDisplayString(e.text), 1)
        ])
...
var $i = ["aria-current", "aria-label", "onClick"];
var Ti = createBaseVNode("span", {
  class: "carousel-control-prev-icon",
  "aria-hidden": "true"
}, null, -1);
var Si = { class: "visually-hidden" };
var Vi = createBaseVNode("span", {
  class: "carousel-control-next-icon",
  "aria-hidden": "true"
}, null, -1);
var _i = { class: "visually-hidden" };
var Ai = defineComponent({
  ...
  setup(t, { expose: e, emit: l }) {
    const a = t, o = l, r = useSlots(), n = Be(() => a.id, "carousel"), s = useModel(t, "modelValue"), i = be(() => a.touchThreshold), u = be(() => a.interval), d = ref(false), p = ref(false), f = ref(true), m = ref(null), y = ref(null), c = ref(s.value), g = Ua(y), v = toRef(
      ...
      () => a.ride === true && p.value === true || a.ride === "carousel"
    ), _ = computed(() => Br(r.default, "BCarouselSlide")), F = computed(() => ({ "carousel-fade": a.fade })), Q = (A) => {
      var K;
      return new ql(A, {
        componentId: n.value,
        cancelable: false,
      ...
      if (d.value !== true) {
        if (a.ride === true && (p.value = true), w.value === true && C(), f.value = !(A < s.value), A >= _.value.length) {
          if (a.noWrap)
            return;
          s.value = 0;
          return;
      ...
      o("slide", Q("slide")), d.value = true;
    }, M = () => {
      o("slid", Q("slid")), d.value = false;
    }, j = (A) => {
    ...
    return Re(
    ...
    }), (A, K) => (openBlock(), createElementBlock("div", {
      id: unref(n),
      ref_key: "element",
      ref: y,
      class: normalizeClass(["carousel slide pointer-event", F.value])
    }, [
      a.indicators ? (openBlock(), createElementBlock("div", ki, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(_.value.length, (G, ie) => (openBlock(), createElementBlock("button", {
          key: ie,
          type: "button",
          "data-bs-target": "",
          class: normalizeClass(ie === s.value ? "active" : ""),
          "aria-current": ie === s.value ? true : void 0,
      ...
      createBaseVNode("div", {
        ...
        createVNode(TransitionGroup, {
          ...
          "leave-from-class": h2.value,
          "leave-active-class": h2.value,
          "leave-to-class": h2.value,
          onBeforeLeave: E,
          onAfterLeave: M,
          onAfterEnter: j
        }, {
          default: withCtx(() => [
            (openBlock(true), createElementBlock(Fragment, null, renderList(_.value, (G, ie) => withDirectives((openBlock(), createBlock(resolveDynamicComponent(G), {
              key: ie,
              class: normalizeClass({ active: ie === s.value && d.value === false })
            }, null, 8, ["class"])), [
              [vShow, ie === s.value]
            ])), 128))
          ]),
      ...
      a.controls ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [
        createBaseVNode("button", {
          ...
          Ti,
          createBaseVNode("span", Si, toDisplayString(A.controlsPrevText), 1)
        ]),
        createBaseVNode("button", {
          ...
          Vi,
          createBaseVNode("span", _i, toDisplayString(A.controlsNextText), 1)
        ])
      ], 64)) : createCommentVNode("", true)
    ], 10, Ci));
  }
...
var Ei = defineComponent({
  ...
  setup(t) {
    const e = t, l = useSlots(), a = inject(ko, null), o = toRef(() => e.text || e.textHtml || !Ae(l.text)), r = toRef(() => e.caption || e.captionHtml || !Ae(l.caption)), n = toRef(() => o.value || r.value || !Ae(l.default)), s = computed(() => ({
      ...
      renderSlot(u.$slots, "img", {}, () => {
        ...
        return [
          createVNode(el, {
            ...
            srcset: u.imgSrcset,
            src: u.imgSrc,
            width: u.imgWidth || ((p = unref(a)) == null ? void 0 : p.width.value),
            height: u.imgHeight || ((f = unref(a)) == null ? void 0 : f.height.value),
            blank: u.imgBlank,
            "blank-color": u.imgBlankColor
          }, null, 8, ["alt", "srcset", "src", "width", "height", "blank", "blank-color"])
        ];
      }),
      n.value ? (openBlock(), createBlock(resolveDynamicComponent(u.contentTag), {
        key: 0,
        class: normalizeClass(["carousel-caption", i.value])
      }, {
        default: withCtx(() => [
          r.value ? (openBlock(), createBlock(resolveDynamicComponent(u.captionTag), { key: 0 }, {
            default: withCtx(() => [
              renderSlot(u.$slots, "caption", {}, () => [
                u.captionHtml ? (openBlock(), createElementBlock("span", {
                  key: 0,
                  innerHTML: u.captionHtml
                }, null, 8, Oi)) : (openBlock(), createElementBlock("span", Ni, toDisplayString(u.caption), 1))
              ])
            ]),
            _: 3
          })) : createCommentVNode("", true),
          o.value ? (openBlock(), createBlock(resolveDynamicComponent(u.textTag), { key: 1 }, {
            default: withCtx(() => [
              renderSlot(u.$slots, "text", {}, () => [
                u.textHtml ? (openBlock(), createElementBlock("span", {
                  key: 0,
                  innerHTML: u.textHtml
                }, null, 8, Ii)) : (openBlock(), createElementBlock("span", Pi, toDisplayString(u.text), 1))
              ])
            ]),
            _: 3
          })) : createCommentVNode("", true),
...
var Tl = fa("", [], { type: [Boolean, String, Number], default: false });
var Sl = fa("offset", [""], { type: [String, Number], default: null });
var Vl = fa("order", [""], { type: [String, Number], default: null });
var Li = defineComponent({
  name: "BCol",
  slots: Object,
  props: {
...
function Fi(t, e, l, a, o, r) {
  return openBlock(), createBlock(resolveDynamicComponent(t.tag), {
    class: normalizeClass(t.computedClasses)
  }, {
    default: withCtx(() => [
...
var zi = defineComponent({
  ...
  setup(t) {
    const e = t, l = be(() => e.gutterX ?? NaN, { method: "parseInt" }), a = be(() => e.gutterY ?? NaN, { method: "parseInt" }), o = computed(() => ({
...
var Hi = { class: "visually-hidden" };
var Ri = ["aria-labelledby", "role"];
var dn = defineComponent({
  ...
  setup(t, { expose: e, emit: l }) {
    const a = t, o = l, r = Be(() => a.id, "dropdown"), n = useModel(t, "modelValue"), s = toRef(
      () => typeof a.offset == "string" || typeof a.offset == "number" ? a.offset : NaN
    ), i = be(s), u = ref(null), d = ref(null), p = ref(null), f = ref(null), m = computed(
      () => a.boundary === "document" || a.boundary === "viewport" ? void 0 : a.boundary
    ), y = computed(
      () => a.boundary === "document" || a.boundary === "viewport" ? a.boundary : void 0
    ), c = toRef(() => a.split ? d.value : p.value);
    Re(
      "Escape",
      () => {
        n.value = !n.value;
    ...
    const v = computed(
      ...
      return a.noFlip === false && S.push(
        so({
          boundary: m.value,
          rootBoundary: y.value,
          padding: a.boundaryPadding
        })
      ), a.noShift === false && S.push(
        no({
          boundary: m.value,
          rootBoundary: y.value,
          padding: a.boundaryPadding
        })
      ), a.noSize === false && S.push(
        ro({
          boundary: m.value,
          rootBoundary: y.value,
          padding: a.boundaryPadding,
    ...
    yo(
      u,
      () => {
        n.value && (a.autoClose === true || a.autoClose === "outside") && le();
      },
      { ignore: [d, p] }
    );
    const L = () => {
      n.value && (a.autoClose === true || a.autoClose === "inside") && le();
    }, J = () => {
      n.value && le();
    }, R = () => {
      n.value || le();
    ...
    return watch(n, () => {
      ...
      hide: J,
      toggle: le,
      visible: toRef(() => n.value),
      isNav: toRef(() => a.isNav)
    }), (N, S) => (openBlock(), createElementBlock("div", {
      ref_key: "wrapper",
      ref: f,
      class: normalizeClass([_.value, "btn-group"])
    }, [
      createVNode(vt, {
        id: unref(r),
        ref_key: "splitButton",
      ...
      a.split ? (openBlock(), createBlock(vt, {
        key: 0,
        ref_key: "button",
        ref: d,
        variant: N.variant,
        size: N.size,
        disabled: N.disabled,
        class: normalizeClass([[N.toggleClass, { show: n.value }], "dropdown-toggle-split dropdown-toggle"]),
        "aria-expanded": n.value,
        "aria-haspopup": "menu",
        onClick: Q
      }, {
        default: withCtx(() => [
          createBaseVNode("span", Hi, [
      ...
      (openBlock(), createBlock(Teleport, {
        ...
        !a.lazy || n.value ? withDirectives((openBlock(), createElementBlock("ul", {
          key: 0,
          ref_key: "floating",
          ref: u,
          style: normalizeStyle([unref(w), h2.value]),
          class: normalizeClass(["dropdown-menu overflow-auto", [N.menuClass, { show: n.value }]]),
          ...
          [vShow, a.lazy || n.value]
        ]) : createCommentVNode("", true)
      ], 8, ["to", "disabled"]))
    ], 2));
  }
});
var Mi = { role: "presentation" };
var xi = defineComponent({
  ...
  setup(t) {
    return (e, l) => (openBlock(), createElementBlock("li", Mi, [
...
var Di = { role: "presentation" };
var ji = defineComponent({
  __name: "BDropdownForm",
  setup(t) {
    return (e, l) => (openBlock(), createElementBlock("li", Di, [
      createBaseVNode("form", mergeProps({ class: "dropdown-item-text" }, e.$attrs), [
        renderSlot(e.$slots, "default")
      ], 16)
    ]));
  }
...
var Gi = defineComponent({
  ...
  setup(t) {
    const e = t, l = toRef(() => e.id ? `${e.id}_group_dd_header` : void 0), a = toRef(() => e.headerTag === "header" ? void 0 : "heading"), o = computed(() => [
      e.headerClass,
      {
        [`text-${e.headerVariant}`]: e.headerVariant !== null
      }
    ]);
    return (r, n) => (openBlock(), createElementBlock("li", qi, [
...
var Ui = { class: "dropdown-header" };
var Xi = defineComponent({
  __name: "BDropdownHeader",
  setup(t) {
    return (e, l) => (openBlock(), createElementBlock("li", null, [
      createBaseVNode("h6", Ui, [
        renderSlot(e.$slots, "default")
      ])
    ]));
  }
...
var Ki = defineComponent({
  ...
  emits: ["click"],
  setup(t, { emit: e }) {
    const l = t, a = e, { class: o, ...r } = useAttrs(), { computedLink: n, computedLinkProps: s } = wt(l), i = computed(() => [
      l.linkClass,
      {
        active: l.active,
        disabled: l.disabled,
    ...
    ]), u = toRef(() => n.value ? lt : l.href ? "a" : "button"), d = inject(Ka, null), p = inject(No, null), f = inject(Ya, null), m = (y) => {
      var c, g, v;
      a("click", y), f !== null && ((c = f == null ? void 0 : f.autoClose) == null ? void 0 : c.value) === true && ((g = d == null ? void 0 : d.hide) == null || g.call(d)), (v = p == null ? void 0 : p.hide) == null || v.call(p);
    };
    return (y, c) => (openBlock(), createElementBlock("li", mergeProps({
      role: "presentation",
      class: unref(o)
    }, y.wrapperAttrs), [
      (openBlock(), createBlock(resolveDynamicComponent(u.value), mergeProps({
        ...
        disabled: l.disabled,
        "aria-disabled": l.disabled ? true : null,
        "aria-current": l.active ? true : null,
...
var Zi = defineComponent({
  ...
  setup(t, { emit: e }) {
    ...
    return (n, s) => (openBlock(), createElementBlock("li", Yi, [
      createBaseVNode("button", {
        role: "menu",
        type: "button",
        class: normalizeClass(["dropdown-item", o.value]),
        disabled: l.disabled,
        onClick: r
      }, [
        renderSlot(n.$slots, "default")
...
var eu = defineComponent({
  ...
  setup(t) {
    return (e, l) => (openBlock(), createElementBlock("li", Qi, [
      createBaseVNode("span", mergeProps({ class: "dropdown-item-text" }, e.$attrs), [
        renderSlot(e.$slots, "default", {}, () => [
          createTextVNode(toDisplayString(e.text), 1)
        ])
      ], 16)
...
var cn = defineComponent({
  ...
  emits: ["submit"],
  setup(t, { expose: e, emit: l }) {
    const a = t, o = l, r = ref(null), n = computed(() => ({
    ...
    return e({
      element: r
    }), (i, u) => (openBlock(), createElementBlock("form", {
      id: i.id,
      ref_key: "element",
      ref: r,
...
var ou = defineComponent({
  ...
  setup(t) {
    return (e, l) => (openBlock(), createElementBlock("div", au, [
      renderSlot(e.$slots, "default", {}, () => [
        createTextVNode(toDisplayString(e.text), 1)
      ]),
...
var _a = defineComponent({
  ...
  setup(t) {
    const e = t, l = toRef(() => e.forceShow === true || e.state === false), a = computed(() => ({
      "d-block": l.value,
    ...
    return (o, r) => (openBlock(), createBlock(resolveDynamicComponent(o.tag), {
      ...
      "aria-atomic": o.ariaLive ? true : void 0,
      class: normalizeClass(a.value)
    }, {
      default: withCtx(() => [
        renderSlot(o.$slots, "default", {}, () => [
...
var Qt = defineComponent({
  ...
  setup(t) {
    return (e, l) => (openBlock(), createBlock(resolveDynamicComponent(e.tag), { class: "row d-flex flex-wrap" }, {
      default: withCtx(() => [
        renderSlot(e.$slots, "default")
      ]),
      _: 3
...
var Oa = defineComponent({
  ...
  setup(t) {
    const e = t, l = toRef(() => e.forceShow === true || e.state === true), a = computed(() => ({
      "d-block": l.value,
...
var fn = defineComponent({
  ...
  setup(t, { slots: e, attrs: l }) {
    return () => {
      var a, o, r;
      return t.skip ? (a = e.default) == null ? void 0 : a.call(e) : t.tag === "Teleport" ? h(Teleport, { to: t.to }, [(o = e.default) == null ? void 0 : o.call(e)]) : h(t.tag, { ...l }, [(r = e.default) == null ? void 0 : r.call(e)]);
    };
  }
});
var nu = ["id", "disabled", "required", "name", "form", "aria-label", "aria-labelledby", "aria-required", "value", "true-value", "false-value", "indeterminate"];
var su = ["for"];
var vn = defineComponent({
  ...
  props: mergeModels({
    ...
    uncheckedValue: { type: [String, Boolean, Object, Number, null], default: false },
  ...
  setup(t, { expose: e }) {
    const l = t, a = useSlots(), o = useModel(t, "modelValue"), r = useModel(t, "indeterminate"), n = Be(() => l.id, "form-check"), s = inject(Ao, null), i = ref(null), { focused: u } = Pe(i, {
      initialValue: l.autofocus
    }), d = toRef(() => !Ae(a.default)), p = computed({
      get: () => (s == null ? void 0 : s.modelValue.value) ?? o.value,
      set: (h2) => {
        if (h2 !== void 0) {
          if (r.value = false, s !== null && Array.isArray(h2)) {
            s.modelValue.value = h2;
            return;
          }
          o.value = h2;
        }
    ...
    ), m = toRef(() => l.buttonGroup || ((s == null ? void 0 : s.buttons.value) ?? false)), y = computed(() => ({
      plain: l.plain || ((s == null ? void 0 : s.plain.value) ?? false),
      button: l.button || ((s == null ? void 0 : s.buttons.value) ?? false),
      inline: l.inline || ((s == null ? void 0 : s.inline.value) ?? false),
      reverse: l.reverse || ((s == null ? void 0 : s.reverse.value) ?? false),
      switch: l.switch || ((s == null ? void 0 : s.switch.value) ?? false),
    ...
    return e({
      ...
      default: withCtx(() => {
        var C, w, _;
        return [
          withDirectives(createBaseVNode("input", mergeProps({ id: unref(n) }, h2.$attrs, {
            ref_key: "input",
            ref: i,
            "onUpdate:modelValue": k[0] || (k[0] = (F) => p.value = F),
            class: unref(g),
            type: "checkbox",
            disabled: l.disabled || ((C = unref(s)) == null ? void 0 : C.disabled.value),
            required: f.value || void 0,
            name: h2.name || ((w = unref(s)) == null ? void 0 : w.name.value),
            form: h2.form || ((_ = unref(s)) == null ? void 0 : _.form.value),
            "aria-label": h2.ariaLabel,
            "aria-labelledby": h2.ariaLabelledby,
            "aria-required": f.value || void 0,
            value: h2.value,
            "true-value": h2.value,
            "false-value": h2.uncheckedValue,
            indeterminate: l.indeterminate
          }), null, 16, nu), [
            [vModelCheckbox, p.value]
          ]),
          d.value || l.plain === false ? (openBlock(), createElementBlock("label", {
            key: 0,
            for: unref(n),
            class: normalizeClass(unref(v))
          }, [
            renderSlot(h2.$slots, "default")
          ], 10, su)) : createCommentVNode("", true)
        ];
      }),
      _: 3
    }, 8, ["skip", "class"]));
...
var uu = defineComponent({
  ...
  emits: ["update:modelValue"],
  setup(t, { expose: e }) {
    const l = t, a = useModel(t, "modelValue"), o = Be(() => l.id, "checkbox"), r = Be(() => l.name, "checkbox"), n = ref(null), { focused: s } = Pe(n, {
      initialValue: l.autofocus
    });
    provide(Ao, {
      modelValue: a,
      switch: toRef(() => l.switches),
      buttonVariant: toRef(() => l.buttonVariant),
      form: toRef(() => l.form),
      name: r,
      state: toRef(() => l.state),
      plain: toRef(() => l.plain),
      size: toRef(() => l.size),
      inline: toRef(() => !l.stacked),
      reverse: toRef(() => l.reverse),
      required: toRef(() => l.required),
      buttons: toRef(() => l.buttons),
      disabled: toRef(() => l.disabled)
    });
    const i = computed(
      () => l.options.map(
    ...
    return e({
    ...
    }), (f, m) => (openBlock(), createElementBlock("div", mergeProps(unref(d), {
      id: unref(o),
      ref_key: "element",
      ref: n,
      role: "group",
      ...
      (openBlock(true), createElementBlock(Fragment, null, renderList(i.value, (y) => (openBlock(), createBlock(vn, mergeProps({
        key: y.self
      }, y.props), {
        default: withCtx(() => [
          y.html ? (openBlock(), createElementBlock("span", {
            key: 0,
            innerHTML: y.html
...
var du = ["for"];
var cu = ["for"];
var fu = { class: "input-group form-input-file" };
var vu = ["id", "form", "name", "multiple", "disabled", "capture", "accept", "required", "aria-label", "aria-labelledby", "aria-required", "directory", "webkitdirectory"];
var pu = defineComponent({
  ...
  emits: ["update:modelValue"],
  setup(t, { expose: e }) {
    const l = useSlots(), a = t, o = useModel(t, "modelValue"), r = Be(() => a.id), n = Ct(() => a.state), s = ref(null), { focused: i } = Pe(s, { initialValue: a.autofocus }), u = toRef(() => !Ae(l.label)), d = toRef(
      ...
      var h2, k;
      const v = ((h2 = s.value) == null ? void 0 : h2.files) === null || ((k = s.value) == null ? void 0 : k.files) === void 0 ? null : [...s.value.files];
      o.value = v === null ? null : a.multiple === true ? v : v[0];
    }, m = (v) => {
      a.noDrop === true && v.preventDefault();
    }, y = () => {
      o.value = null;
    };
    watch(o, (v) => {
    ...
    const [c, g] = zt();
    return (v, h2) => (openBlock(), createElementBlock(Fragment, null, [
      createVNode(unref(c), null, {
        default: withCtx(() => [
          createBaseVNode("label", {
            class: "input-group-text",
            for: unref(r)
          }, toDisplayString(v.browserText), 9, du)
        ]),
        _: 1
      }),
      u.value || v.label ? (openBlock(), createElementBlock("label", {
        key: 0,
      ...
      createBaseVNode("div", fu, [
        v.placement === "start" ? (openBlock(), createBlock(unref(g), { key: 0 })) : createCommentVNode("", true),
        createBaseVNode("input", mergeProps({ id: unref(r) }, v.$attrs, {
          ref_key: "input",
          ref: s,
          type: "file",
        ...
        v.placement === "end" ? (openBlock(), createBlock(unref(g), { key: 1 })) : createCommentVNode("", true)
      ])
    ], 64));
  }
});
var mu = qt(pu, [["__scopeId", "data-v-1eb930f5"]]);
var pn = ["input", "select", "textarea"];
var bu = pn.map((t) => `${t}:not([disabled])`).join();
var yu = [...pn, "a", "button", "label"];
var gu = "label";
var hu = "invalid-feedback";
var Bu = "valid-feedback";
var wu = "description";
var Cu = "default";
var ku = defineComponent({
  ...
  setup(t) {
    const l = ["xs", "sm", "md", "lg", "xl"], a = (y, c) => l.reduce((g, v) => {
      const h2 = wl(v === "xs" ? "" : v, `${c}Align`), k = y[h2] || null;
      return k && (v === "xs" ? g.push(`text-${k}`) : g.push(`text-${v}-${k}`)), g;
    }, []), o = (y, c) => (
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      l.reduce((g, v) => {
        const h2 = wl(v === "xs" ? "" : v, `${c}Cols`);
        let k = y[h2];
        if (k = k === "" ? true : k || false, typeof k != "boolean" && k !== "auto") {
          const C = Number.parseInt(k);
          k = Number.isNaN(C) ? 0 : C, k = k > 0 ? k : false;
        }
        return k && (v === "xs" ? g[typeof k == "boolean" ? "col" : "cols"] = k : g[v || (typeof k == "boolean" ? "col" : "cols")] = k), g;
      }, {})
    ), r = ref(null), n = (y, c = null) => {
      if (za && t.labelFor && r.value !== null) {
        const g = r.value.querySelector(`#${CSS.escape(t.labelFor)}`);
        if (g) {
          const v = "aria-describedby", h2 = (y || "").split(Jt), k = (c || "").split(Jt), C = (g.getAttribute(v) || "").split(Jt).filter((w) => !k.includes(w)).concat(h2).filter((w, _, F) => F.indexOf(w) === _).filter((w) => w).join(" ").trim();
          C ? g.setAttribute(v, C) : g.removeAttribute(v);
        }
      }
    }, s = computed(() => o(t, "content")), i = computed(() => a(t, "label")), u = computed(() => o(t, "label")), d = computed(
      () => (
    ...
    return watch(
      ...
      onLegendClick: (y) => {
        ...
        if (yu.indexOf(g) !== -1)
          return;
        const v = [...r.value.querySelectorAll(bu)].filter(Fn), [h2] = v;
        v.length === 1 && h2 instanceof HTMLElement && Ln(h2);
      },
      stateClass: p
    };
  },
  render() {
    ...
    if (r || this.isHorizontal) {
      ...
      if (t.labelSrOnly)
        ...
        this.isHorizontal ? o = h(Lt, w, { default: () => r }) : o = h(C, w, r);
      }
    }
    let s = null;
    ...
    this.isHorizontal && (h2 = h(Lt, { ref: "content", ...this.contentColProps }, { default: () => v }));
    const k = {
      class: [
        this.stateClass,
        {
    ...
    return this.isHorizontal && !a ? h(Qt, k, { default: () => [o, h2] }) : h(
      a ? "fieldset" : "div",
      k,
      this.isHorizontal && a ? [h(Qt, null, { default: () => [o, h2] })] : this.isHorizontal || !t.floating ? [o, h2] : [h2]
    );
  }
});
var $u = ["id", "value", "name", "form", "type", "disabled", "placeholder", "required", "autocomplete", "readonly", "min", "max", "step", "list", "aria-required", "aria-invalid"];
var Tu = defineComponent({
  ...
  emits: ["update:modelValue"],
  setup(t, { expose: e, emit: l }) {
    const a = t, o = l, { input: r, computedId: n, computedAriaInvalid: s, onInput: i, onChange: u, onBlur: d, focus: p, blur: f } = Wo(a, o), m = Ct(() => a.state), y = ref(false), c = computed(() => {
    ...
    return e({
      ...
      element: r,
      focus: p
    }), (g, v) => (openBlock(), createElementBlock("input", {
      id: unref(n),
      ref_key: "input",
      ref: r,
      value: g.modelValue,
      ...
      onInput: v[0] || (v[0] = (h2) => unref(i)(h2)),
      onChange: v[1] || (v[1] = (h2) => unref(u)(h2)),
      onBlur: v[2] || (v[2] = (h2) => unref(d)(h2))
    }, null, 42, $u));
  }
});
var Su = ["id", "disabled", "required", "name", "form", "aria-label", "aria-labelledby", "value", "aria-required"];
var Vu = ["for"];
var mn = defineComponent({
  ...
  emits: ["update:modelValue"],
  setup(t, { expose: e }) {
    const l = t, a = useSlots(), o = useModel(t, "modelValue"), r = Be(() => l.id, "form-check"), n = inject(Oo, null), s = ref(null), { focused: i } = Pe(s, {
      initialValue: l.autofocus
    }), u = toRef(() => !Ae(a.default)), d = computed({
    ...
    ), f = toRef(() => l.buttonGroup || ((n == null ? void 0 : n.buttons.value) ?? false)), m = computed(() => ({
      plain: l.plain || ((n == null ? void 0 : n.plain.value) ?? false),
      button: l.button || ((n == null ? void 0 : n.buttons.value) ?? false),
      inline: l.inline || ((n == null ? void 0 : n.inline.value) ?? false),
      state: l.state || (n == null ? void 0 : n.state.value),
      reverse: l.reverse || ((n == null ? void 0 : n.reverse.value) ?? false),
    ...
    return e({
      ...
      default: withCtx(() => {
        var k, C, w;
        return [
          withDirectives(createBaseVNode("input", mergeProps({ id: unref(r) }, v.$attrs, {
            ref_key: "input",
            ref: s,
            "onUpdate:modelValue": h2[0] || (h2[0] = (_) => d.value = _),
            class: unref(c),
            type: "radio",
            disabled: l.disabled || ((k = unref(n)) == null ? void 0 : k.disabled.value),
            required: p.value || void 0,
            name: v.name || ((C = unref(n)) == null ? void 0 : C.name.value),
            form: v.form || ((w = unref(n)) == null ? void 0 : w.form.value),
            "aria-label": v.ariaLabel,
            "aria-labelledby": v.ariaLabelledby,
            value: v.value,
          ...
          u.value || l.plain === false ? (openBlock(), createElementBlock("label", {
            key: 0,
            for: unref(r),
            class: normalizeClass(unref(g))
          }, [
            renderSlot(v.$slots, "default")
          ], 10, Vu)) : createCommentVNode("", true)
        ];
      }),
      _: 3
    }, 8, ["skip", "class"]));
...
var Ou = defineComponent({
  ...
  emits: ["update:modelValue"],
  setup(t, { expose: e }) {
    const l = t, a = useModel(t, "modelValue"), o = Be(() => l.id, "radio"), r = Be(() => l.name, "checkbox"), n = ref(null), { focused: s } = Pe(n, {
      initialValue: l.autofocus
    });
    provide(Oo, {
      modelValue: a,
    ...
    return e({
      ...
      renderSlot(f.$slots, "first"),
      (openBlock(true), createElementBlock(Fragment, null, renderList(i.value, (y) => (openBlock(), createBlock(mn, {
        key: y.self,
        disabled: y.disabled,
        value: y.value
      }, {
        default: withCtx(() => [
          y.html ? (openBlock(), createElementBlock("span", {
            key: 0,
            innerHTML: y.html
          }, null, 8, Au)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
            createTextVNode(toDisplayString(y.text), 1)
          ], 64))
        ]),
        _: 2
...
var al = defineComponent({
  ...
  setup(t) {
    const e = t;
    return (l, a) => (openBlock(), createElementBlock("option", {
      value: l.value,
      disabled: e.disabled
    }, [
      renderSlot(l.$slots, "default")
...
var bn = defineComponent({
  ...
  setup(t) {
    const e = t, { normalizedOptions: l } = Go(() => e.options, e), a = computed(() => l.value);
    return (o, r) => (openBlock(), createElementBlock("optgroup", { label: o.label }, [
      renderSlot(o.$slots, "first"),
      (openBlock(true), createElementBlock(Fragment, null, renderList(a.value, (n, s) => (openBlock(), createBlock(al, mergeProps({
        key: s,
        disabled: n.disabled,
        value: n.value
      }, o.$attrs), {
        default: withCtx(() => [
          n.html ? (openBlock(), createElementBlock("span", {
            key: 0,
            innerHTML: n.html
          }, null, 8, Pu)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
            createTextVNode(toDisplayString(n.text), 1)
          ], 64))
        ]),
        _: 2
...
var Eu = ["id", "name", "form", "multiple", "size", "disabled", "required", "aria-required", "aria-invalid"];
var Lu = ["innerHTML"];
var Fu = defineComponent({
  ...
  emits: ["update:modelValue"],
  setup(t, { expose: e }) {
    const l = t, a = useModel(t, "modelValue"), o = Be(() => l.id, "input"), r = be(() => l.selectSize), n = Ct(() => l.state), s = ref(null), { focused: i } = Pe(s, {
      initialValue: l.autofocus
    }), u = computed(() => [
      n.value,
      {
      ...
      () => l.ariaInvalid,
      () => l.state
    ), { normalizedOptions: f, isComplex: m } = Go(() => l.options, l), y = computed(
      () => f.value
    ), c = computed({
      get: () => a.value,
      set: (g) => {
    ...
    return e({
    ...
    }), (g, v) => withDirectives((openBlock(), createElementBlock("select", {
      id: unref(o),
      ref_key: "input",
      ref: s,
      "onUpdate:modelValue": v[0] || (v[0] = (h2) => c.value = h2),
      ...
      renderSlot(g.$slots, "first"),
      (openBlock(true), createElementBlock(Fragment, null, renderList(y.value, (h2, k) => (openBlock(), createElementBlock(Fragment, { key: k }, [
        unref(m)(h2) ? (openBlock(), createBlock(bn, {
          key: 0,
          label: h2.label,
          options: h2.options,
        ...
        }, null, 8, ["label", "options", "value-field", "text-field", "html-field", "disabled-field"])) : (openBlock(), createBlock(al, {
          key: 1,
          value: h2.value,
          ...
          default: withCtx(() => [
            h2.html ? (openBlock(), createElementBlock("span", {
              key: 0,
              innerHTML: h2.html
            }, null, 8, Lu)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
...
var Nl = "PageUp";
var Ba = "ArrowUp";
var zu = ["lang", "tabindex", "title"];
var Hu = ["name", "form", "value"];
var Ru = ["id", "dir", "tabindex", "aria-label", "aria-invalid", "aria-required", "aria-valuemin", "aria-valuemax", "aria-valuenow", "aria-valuetext"];
var He = {
  min: 1,
  max: 100,
  step: 1,
...
var Mu = defineComponent({
  ...
  setup(t, { emit: e }) {
    const l = [Ba, ha, Al, _l, Nl, Ol], a = t, o = e, r = useModel(t, "modelValue"), n = ref(null), { focused: s } = Pe(n), i = Be(() => a.id, "spinbutton"), u = computed(() => ({
      disabled: a.disabled,
      readonly: a.readonly,
      focus: s.value,
    ...
    const y = be(() => a.step), c = toRef(
    ...
    }), le = toRef(() => Math.pow(10, R.value || 0)), N = toRef(
      () => r.value === null ? "" : r.value.toFixed(R.value)
    ), { isRtl: S, locale: E } = Hr(), M = computed(() => {
      ...
      notation: "standard"
    }).format, A = toRef(() => a.formatterFn ?? j()), K = (z) => {
      let { value: oe } = r;
    ...
    Re(
      ...
      (z) => {
        ...
        a.disabled || a.readonly || oe || fe || ce || (q(z), ee(), m = false, o("change", r.value));
      },
    ...
    const ne = (z, oe) => {
      ...
      ge(z) && z.type === "mouseup" && z.button || (q(z), ee(), ye(false), o("change", r.value));
    }, ye = (z) => {
      try {
        sl(z, [document.body, "mouseup", te, false]), sl(z, [document.body, "touchend", te, false]);
      } catch {
      }
    }, ee = () => {
      ...
      const z = {
        ...
        !a.disabled && !a.readonly && (q(Ke), ye(true), s.value = true, ne(Ke, $n));
      }, $e = {
        button: {
          ...fe,
    ...
    return (z, oe) => (openBlock(), createElementBlock("div", {
      ref_key: "element",
      ref: n,
      class: normalizeClass(["b-form-spinbutton form-control", u.value]),
      role: "group",
      lang: M.value,
      tabindex: a.disabled ? void 0 : "-1",
      title: z.ariaLabel,
      onClick: oe[4] || (oe[4] = (fe) => s.value = true)
    }, [
      renderSlot(z.$slots, U.value.top.slot.name, { hasFocus: unref(s) }, () => [
        createBaseVNode("button", mergeProps(U.value.top.button, {
          onMousedown: oe[0] || (oe[0] = //@ts-ignore
          (...fe) => U.value.top.handler && U.value.top.handler(...fe)),
          onTouchstart: oe[1] || (oe[1] = //@ts-ignore
          (...fe) => U.value.top.handler && U.value.top.handler(...fe))
        }), [
          (openBlock(), createElementBlock("svg", normalizeProps(guardReactiveProps(U.value.top.svg)), [
            createBaseVNode("path", normalizeProps(guardReactiveProps(U.value.top.path)), null, 16)
          ], 16))
        ], 16)
      ]),
      z.name && !a.disabled ? (openBlock(), createElementBlock("input", {
        key: "hidden",
        type: "hidden",
        name: z.name,
        form: z.form,
      ...
      createBaseVNode("output", {
        id: unref(i),
        key: "output",
        class: normalizeClass(["flex-grow-1", d.value]),
        dir: unref(S) ?? false ? "rtl" : "ltr",
        tabindex: a.disabled ? void 0 : "0",
        role: "spinbutton",
        "aria-live": "off",
        "aria-label": z.ariaLabel || void 0,
        "aria-invalid": a.state === false || !r.value !== null && a.required ? true : void 0,
        ...
        createBaseVNode("bdi", null, toDisplayString((r.value !== null ? A.value(r.value) : z.placeholder) || ""), 1)
      ], 10, Ru),
      renderSlot(z.$slots, U.value.bottom.slot.name, { hasFocus: unref(s) }, () => [
        createBaseVNode("button", mergeProps(U.value.bottom.button, {
          onMousedown: oe[2] || (oe[2] = //@ts-ignore
          (...fe) => U.value.bottom.handler && U.value.bottom.handler(...fe)),
          onTouchstart: oe[3] || (oe[3] = //@ts-ignore
          (...fe) => U.value.bottom.handler && U.value.bottom.handler(...fe))
        }), [
          (openBlock(), createElementBlock("svg", normalizeProps(guardReactiveProps(U.value.bottom.svg)), [
            createBaseVNode("path", normalizeProps(guardReactiveProps(U.value.bottom.path)), null, 16)
          ], 16))
        ], 16)
      ])
    ], 10, zu));
...
var yn = defineComponent({
  ...
  emits: ["remove"],
  setup(t, { emit: e }) {
    const l = t, a = e, o = useSlots(), r = Be(() => l.id), n = computed(
      () => {
        var u;
        return ((((u = o.default) == null ? void 0 : u.call(o, {})[0].children) ?? "").toString() || l.title) ?? "";
      }
    ), s = toRef(() => `${r.value}taglabel__`), i = computed(() => ({
    ...
    return (u, d) => (openBlock(), createBlock(resolveDynamicComponent(u.tag), {
      id: unref(r),
      title: n.value,
      class: normalizeClass(["badge b-form-tag d-inline-flex align-items-center mw-100", i.value]),
      ...
      default: withCtx(() => [
        ...
        !l.disabled && !l.noRemove ? (openBlock(), createBlock(Pt, {
          key: 0,
...
var Du = ["id"];
var ju = ["id", "for", "aria-live"];
var qu = ["id", "aria-live"];
var Wu = ["id"];
var Gu = ["aria-controls"];
var Uu = {
  role: "group",
  class: "d-flex"
};
var Xu = ["id", "disabled", "value", "type", "placeholder", "form", "required", "aria-required"];
var Ku = ["disabled"];
var Yu = {
  "aria-live": "polite",
  "aria-atomic": "true"
...
var td = defineComponent({
  ...
  setup(t, { expose: e, emit: l }) {
    const a = t, o = l, r = useModel(t, "modelValue"), n = Be(), s = be(() => a.limit ?? NaN), i = Ct(() => a.state), u = ref(null), { focused: d } = Pe(u, {
      initialValue: a.autofocus
    }), p = toRef(() => a.inputId || `${n.value}input__`), f = ref([...r.value]), m = ref(""), y = ref(r.value.length > 0), c = ref(""), g = ref([]), v = ref([]), h2 = ref([]);
    Sa(r, f, {
      direction: "ltr",
      transform: {
        ltr: (A) => [...A]
    ...
    const k = computed(() => [
    ...
    ]), C = computed(() => f.value.includes(m.value)), w = computed(
      () => m.value === "" ? false : !a.tagValidator(m.value)
    ), _ = toRef(() => f.value.length === s.value), F = toRef(() => !w.value && !C.value), Q = computed(() => ({
      ...
      a.disabled || a.noOuterFocus || (d.value = true, o("focus", A));
    }, J = (A) => {
      d.value = false, o("blur", A);
    }, R = (A) => {
      var G, ie;
      const K = typeof A == "string" ? A : A.target.value;
      if (y.value = false, (G = a.separator) != null && G.includes(K.charAt(0)) && K.length > 0) {
      ...
      g.value = a.tagValidator(K) && !C.value ? [K] : [], v.value = a.tagValidator(K) ? [] : [K], h2.value = C.value ? [K] : [], o("tag-state", g.value, v.value, h2.value);
    }, le = (A) => {
      ...
      (A.key === "Backspace" || A.key === "Delete") && a.removeOnDelete && m.value === "" && y.value && f.value.length > 0 ? j(f.value[f.value.length - 1]) : y.value = true;
    };
    Re(N, { target: u });
    const S = computed(() => {
      if (a.separator)
      ...
      const ie = [...r.value, ...G];
      m.value = "", y.value = true, r.value = ie, d.value = true;
    }, j = (A) => {
    ...
    return e({
      ...
      id: unref(n),
      class: normalizeClass(["b-form-tags form-control h-auto", k.value]),
      role: "group",
      tabindex: "-1",
      onFocusin: W,
      ...
      createBaseVNode("output", {
        ...
        class: "visually-hidden",
        for: p.value,
        "aria-live": unref(d) ? "polite" : "off",
        "aria-atomic": "true",
        "aria-relevant": "additions text"
      }, toDisplayString(f.value.join(", ")), 9, ju),
      createBaseVNode("div", {
        id: `${unref(n)}removed_tags__`,
        role: "status",
        "aria-live": unref(d) ? "assertive" : "off",
        "aria-atomic": "true",
        class: "visually-hidden"
      }, " (" + toDisplayString(A.tagRemovedLabel) + ") " + toDisplayString(c.value), 9, qu),
      renderSlot(A.$slots, "default", normalizeProps(guardReactiveProps(Q.value)), () => [
        createBaseVNode("ul", {
          id: `${unref(n)}tag_list__`,
          class: "b-form-tags-list list-unstyled mb-0 d-flex flex-wrap align-items-center"
        }, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(f.value, (G, ie) => renderSlot(A.$slots, "tag", {
            key: ie,
            tag: G,
            tagClass: A.tagClass,
            tagVariant: A.tagVariant,
            ...
            (openBlock(), createBlock(yn, {
              key: G,
              class: normalizeClass(A.tagClass),
              tag: "li",
          ...
          createBaseVNode("li", {
            ...
            createBaseVNode("div", Uu, [
              ...
              F.value ? (openBlock(), createElementBlock("button", {
                ...
                renderSlot(A.$slots, "add-button-text", {}, () => [
                  createTextVNode(toDisplayString(A.addButtonText), 1)
                ])
        ...
        createBaseVNode("div", Yu, [
          w.value ? (openBlock(), createElementBlock("div", Ju, toDisplayString(A.invalidTagText) + ": " + toDisplayString(m.value), 1)) : createCommentVNode("", true),
          C.value ? (openBlock(), createElementBlock("small", Zu, toDisplayString(A.duplicateTagText) + ": " + toDisplayString(m.value), 1)) : createCommentVNode("", true),
          f.value.length === A.limit ? (openBlock(), createElementBlock("small", Qu, toDisplayString(A.limitTagsText), 1)) : createCommentVNode("", true)
        ])
      ]),
      A.name ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(f.value, (G, ie) => (openBlock(), createElementBlock("input", {
        key: ie,
        type: "hidden",
        name: A.name,
        value: G
      }, null, 8, ed))), 128)) : createCommentVNode("", true)
    ], 42, Du));
  }
});
var ad = ["id", "name", "form", "value", "disabled", "placeholder", "required", "autocomplete", "readonly", "aria-required", "aria-invalid", "rows", "wrap"];
var ld = defineComponent({
  ...
  emits: ["update:modelValue"],
  setup(t, { expose: e, emit: l }) {
    const a = t, o = l, { input: r, computedId: n, computedAriaInvalid: s, onInput: i, onChange: u, onBlur: d, focus: p, blur: f } = Wo(a, o), m = Ct(() => a.state), y = computed(() => [
      m.value,
    ...
    return e({
      ...
      element: r,
      focus: p
    }), (g, v) => (openBlock(), createElementBlock("textarea", {
      id: unref(n),
      ref_key: "input",
      ref: r,
...
var dd = defineComponent({
  ...
  setup(t) {
    ...
    })), a = toRef(() => !!e.append || !!e.appendHtml), o = toRef(() => !!e.prepend || !!e.prependHtml);
    return (r, n) => (openBlock(), createBlock(resolveDynamicComponent(r.tag), {
      id: r.id,
      ...
      default: withCtx(() => [
        renderSlot(r.$slots, "prepend", {}, () => [
          o.value ? (openBlock(), createElementBlock("span", od, [
            r.prependHtml ? (openBlock(), createElementBlock("span", {
              key: 0,
              innerHTML: r.prependHtml
            }, null, 8, nd)) : (openBlock(), createElementBlock("span", sd, toDisplayString(r.prepend), 1))
          ])) : createCommentVNode("", true)
        ]),
        renderSlot(r.$slots, "default"),
        renderSlot(r.$slots, "append", {}, () => [
          a.value ? (openBlock(), createElementBlock("span", rd, [
            r.appendHtml ? (openBlock(), createElementBlock("span", {
              key: 0,
              innerHTML: r.appendHtml
            }, null, 8, id)) : (openBlock(), createElementBlock("span", ud, toDisplayString(r.append), 1))
          ])) : createCommentVNode("", true)
        ])
      ]),
      _: 3
...
var gn = defineComponent({
  ...
  setup(t) {
    return (e, l) => (openBlock(), createBlock(resolveDynamicComponent(e.tag), { class: "input-group-text" }, {
      default: withCtx(() => [
        renderSlot(e.$slots, "default", {}, () => [
          createTextVNode(toDisplayString(e.text), 1)
        ])
...
var ll = defineComponent({
  ...
  setup(t) {
    const e = t;
    return (l, a) => e.isText ? (openBlock(), createBlock(gn, { key: 0 }, {
      default: withCtx(() => [
        renderSlot(l.$slots, "default")
      ]),
      _: 3
...
var cd = defineComponent({
  ...
  setup(t) {
    return (e, l) => (openBlock(), createBlock(ll, normalizeProps(guardReactiveProps(e.$props)), {
      default: withCtx(() => [
        renderSlot(e.$slots, "default")
      ]),
      _: 3
...
var vd = defineComponent({
  ...
  setup(t) {
    const e = t, l = computed(() => {
      const o = e.flush ? false : e.horizontal;
      return {
        "list-group-flush": e.flush,
        "list-group-horizontal": o === true,
    ...
    }), (o, r) => (openBlock(), createBlock(resolveDynamicComponent(a.value), {
      class: normalizeClass(["list-group", l.value])
    }, {
      default: withCtx(() => [
        renderSlot(o.$slots, "default")
      ]),
...
var pd = defineComponent({
  ...
  setup(t) {
    const e = t, l = useAttrs(), a = inject(So, null), { computedLink: o } = wt(e), r = toRef(() => !e.button && o.value), n = toRef(
      ...
      const d = {};
      return e.button && ((!l || !l.type) && (d.type = "button"), e.disabled && (d.disabled = true)), d;
    });
    return (d, p) => (openBlock(), createBlock(resolveDynamicComponent(n.value), mergeProps({
...
var md = { id: "__BVID__modal-container" };
var bd = defineComponent({
  ...
  setup(t, { expose: e }) {
    ...
    return e({
      ...
      show: r,
      confirm: n
    }), (i, u) => (openBlock(), createBlock(Teleport, {
      to: i.teleportTo,
      disabled: l.teleportDisabled
    }, [
      createBaseVNode("div", md, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(unref(a), (d, p) => (openBlock(), createBlock(resolveDynamicComponent(d.value.component), mergeProps({
          key: p,
          ...
          onHide: (f) => {
            if (d.value.props._isConfirm === true) {
              if (f.trigger === "ok") {
                d.value.props._promise.resolve(true);
                return;
              }
              if (f.trigger === "cancel") {
                d.value.props._promise.resolve(false);
                return;
              }
          ...
          onHidden: (f) => {
            var m;
            return (m = unref(o)) == null ? void 0 : m(d.value.props._self);
          }
...
var yd = defineComponent({
  ...
  setup(t) {
    const e = t, l = Dt(() => e.align), a = computed(() => ({
      "nav-tabs": e.tabs,
...
var gd = { class: "d-flex flex-row align-items-center flex-wrap" };
var hd = defineComponent({
  ...
  setup(t, { emit: e }) {
    ...
    return (o, r) => (openBlock(), createElementBlock("li", gd, [
      createVNode(cn, mergeProps(o.$attrs, {
        id: o.id,
        floating: o.floating,
        role: o.role,
...
var wd = defineComponent({
  ...
  setup(t, { emit: e }) {
    ...
    return o.value.activeClass, (r, n) => (openBlock(), createElementBlock("li", Bd, [
...
var Cd = { class: "nav-item dropdown" };
var kd = defineComponent({
  ...
  emits: mergeModels(["click", "hidden", "hide", "hide-prevented", "show", "show-prevented", "shown", "toggle"], ["update:modelValue"]),
  setup(t, { expose: e, emit: l }) {
    const a = t, o = l, r = useModel(t, "modelValue"), n = ref(null), s = () => {
      var d;
    ...
    }), (d, p) => (openBlock(), createElementBlock("li", Cd, [
...
var Td = defineComponent({
  ...
  setup(t) {
    return (e, l) => (openBlock(), createElementBlock("li", $d, [
      renderSlot(e.$slots, "default", {}, () => [
        createTextVNode(toDisplayString(e.text), 1)
      ])
    ]));
...
var Sd = defineComponent({
  ...
  setup(t) {
    const e = t, l = toRef(() => e.tag === "nav" ? void 0 : "navigation"), a = Er(() => e.container), o = computed(() => ({
      "d-print": e.print,
    ...
    }), (r, n) => (openBlock(), createBlock(resolveDynamicComponent(r.tag), {
      class: normalizeClass(["navbar", o.value]),
      role: l.value
    }, {
      default: withCtx(() => [
...
var Vd = defineComponent({
  ...
  setup(t) {
    const e = t, { computedLink: l, computedLinkProps: a } = wt(e, [
      ...
      "underlineOpacityHover",
      "icon"
    ]), o = toRef(() => l.value ? lt : e.tag);
    return (r, n) => (openBlock(), createBlock(resolveDynamicComponent(o.value), mergeProps({ class: "navbar-brand" }, unref(a)), {
      default: withCtx(() => [
        renderSlot(r.$slots, "default")
      ]),
      _: 3
...
var _d = defineComponent({
  ...
  setup(t) {
    ...
    return (o, r) => (openBlock(), createElementBlock("ul", {
...
var Il = (t, e) => t.setAttribute("data-bs-theme", e);
var Ad = {
  mounted(t, e) {
    Il(t, e.value);
  },
...
var Ld = ["disabled", "aria-label"];
var Fd = createBaseVNode("span", { class: "navbar-toggler-icon" }, null, -1);
var zd = defineComponent({
  ...
  setup(t, { emit: e }) {
    ...
    return (n, s) => withDirectives((openBlock(), createElementBlock("button", {
      ...
      [unref(Na), l.disabled ? void 0 : n.target]
    ]);
  }
});
var Hd = ["id", "aria-labelledby"];
var Rd = ["id"];
var Md = defineComponent({
  ...
  setup(t, { expose: e, emit: l }) {
    const a = t, o = l, r = useSlots(), n = useModel(t, "modelValue"), s = Be(() => a.id, "offcanvas");
    ...
    const { focused: u } = Pe(i, {
      initialValue: n.value && a.noFocus === false
    }), d = ref(n.value), p = ref(false), f = toRef(() => a.backdrop === true && n.value === true), m = toRef(
      () => a.lazy === false || a.lazy === true && p.value === true || a.lazy === true && n.value === true
    ), y = toRef(() => !Ae(r["header-close"])), c = computed(() => [
      { "text-reset": !y.value },
      a.headerCloseClass
    ]), g = computed(() => ({
      variant: y.value ? a.headerCloseVariant : void 0,
      class: c.value
    })), v = toRef(() => !Ae(r.footer)), h2 = computed(() => [
      // props.responsive === undefined ? 'offcanvas' : `offcanvas-${props.responsive}`,
      "offcanvas",
      // Remove when above check is fixed
      `offcanvas-${a.placement}`,
      {
        show: n.value && d.value === true,
      ...
      const R = C("show", { cancelable: true });
      if (o("show", R), R.defaultPrevented) {
        n.value = false, o("show-prevented");
        return;
      }
      n.value = true;
    }, F = () => {
      nextTick(() => {
        a.noFocus === false && (u.value = true);
      });
    }, Q = () => _(), W = () => {
      d.value = true, F(), o("shown", C("shown")), a.lazy === true && (p.value = true);
    }, L = () => {
      d.value = false;
    }, J = () => {
      o("hidden", C("hidden")), a.lazy === true && (p.value = false);
    };
    return ke(i, "bv-toggle", () => {
      ...
      hide: w,
      show: _
    }), (R, le) => (openBlock(), createBlock(Teleport, {
      to: R.teleportTo,
      disabled: a.teleportDisabled
    }, [
      createVNode(It, {
        ...
        default: withCtx(() => [
          withDirectives(createBaseVNode("div", mergeProps({
            ...
            class: h2.value,
            tabindex: "-1",
            "aria-labelledby": `${unref(s)}-offcanvas-label`,
            "data-bs-backdrop": "false"
          }, R.$attrs), [
            m.value ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
              a.noHeader ? createCommentVNode("", true) : (openBlock(), createElementBlock("div", {
                key: 0,
                class: normalizeClass(["offcanvas-header", R.headerClass])
              }, [
                renderSlot(R.$slots, "header", normalizeProps(guardReactiveProps(k.value)), () => [
                  createBaseVNode("h5", {
                    id: `${unref(s)}-offcanvas-label`,
                    class: "offcanvas-title"
                  }, [
                    renderSlot(R.$slots, "title", normalizeProps(guardReactiveProps(k.value)), () => [
                      createTextVNode(toDisplayString(R.title), 1)
                    ])
                  ], 8, Rd),
                  a.noHeaderClose ? createCommentVNode("", true) : (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                    y.value ? (openBlock(), createBlock(vt, mergeProps({ key: 0 }, g.value, {
                      onClick: le[0] || (le[0] = (N) => w("close"))
                    }), {
                      default: withCtx(() => [
                        renderSlot(R.$slots, "header-close")
                      ]),
                      _: 3
                    }, 16)) : (openBlock(), createBlock(Pt, mergeProps({
                      key: 1,
              ...
              createBaseVNode("div", mergeProps({
                ...
                renderSlot(R.$slots, "default", normalizeProps(guardReactiveProps(k.value)))
              ], 16),
              v.value ? (openBlock(), createElementBlock("div", {
                key: 1,
                class: normalizeClass(R.footerClass)
              }, [
                renderSlot(R.$slots, "footer", normalizeProps(guardReactiveProps(k.value)))
              ], 2)) : createCommentVNode("", true)
            ], 64)) : createCommentVNode("", true)
          ], 16, Hd), [
            [vShow, n.value]
...
var Dd = defineComponent({
  ...
  setup(t, { emit: e }) {
    const i = t, u = e, d = useModel(t, "modelValue"), p = be(() => i.limit, { nanToZero: true, method: "parseInt" }), f = be(() => i.perPage, { nanToZero: true, method: "parseInt" }), m = be(() => i.totalRows, { nanToZero: true, method: "parseInt" }), y = be(d, { nanToZero: true, method: "parseInt" }), c = toRef(() => Math.max(f.value || Fl, 1)), g = toRef(() => Math.max(m.value || zl, 0)), v = toRef(() => Math.ceil(g.value / c.value)), h2 = toRef(() => i.align === "fill"), k = toRef(() => i.align === "fill" ? "start" : i.align), C = Dt(k), w = (te) => te === y.value, _ = (te) => i.disabled ? null : w(te) ? "0" : "-1", F = (te) => i.disabled || w(te) || y.value < 1 || // Check if the number is out of bounds
    te < 1 || te > v.value, Q = computed(() => F(1)), W = computed(() => F(y.value - 1)), L = computed(() => F(v.value)), J = computed(() => F(y.value + 1)), R = ({
      page: te,
      classVal: ye,
      dis: ee,
      slotName: U,
      ...
      button: {
        is: ee ? "span" : "button",
        class: ["page-link", { "flex-grow-1": !ee && h2.value }],
        "aria-label": fe,
    ...
    return (te, ye) => (openBlock(), createElementBlock("ul", {
      class: normalizeClass(["pagination", ie.value]),
      role: "menubar",
      "aria-disabled": i.disabled,
      "aria-label": te.ariaLabel || void 0
    }, [
      createVNode(unref(A).define, null, {
        default: withCtx(({ button: ee, li: U, text: z, clickHandler: oe }) => [
          createBaseVNode("li", normalizeProps(guardReactiveProps(U)), [
            (openBlock(), createBlock(resolveDynamicComponent(ee.is), mergeProps(ee, { onClick: oe }), {
              default: withCtx(() => [
                renderSlot(te.$slots, z.name, {
                  disabled: z.disabled,
                  page: z.page,
                  index: z.index,
                  active: z.active,
      ...
      createVNode(unref(K).define, null, {
        default: withCtx(() => [
          createBaseVNode("li", normalizeProps(guardReactiveProps(G.value.li)), [
            createBaseVNode("span", normalizeProps(guardReactiveProps(G.value.span)), [
              renderSlot(te.$slots, "ellipsis-text", {}, () => [
                createTextVNode(toDisplayString(te.ellipsisText || "..."), 1)
              ])
            ], 16)
          ], 16)
        ]),
      ...
      (openBlock(true), createElementBlock(Fragment, null, renderList(ge.value, (ee) => (openBlock(), createElementBlock(Fragment, {
        key: `page-${ee.number}`
      }, [
        ee === -1 ? (openBlock(), createBlock(unref(A).reuse, normalizeProps(mergeProps({ key: 0 }, S.value)), null, 16)) : ee === -2 ? (openBlock(), createBlock(unref(A).reuse, normalizeProps(mergeProps({ key: 1 }, E.value)), null, 16)) : ee === -3 ? (openBlock(), createBlock(unref(A).reuse, normalizeProps(mergeProps({ key: 2 }, M.value)), null, 16)) : ee === -4 ? (openBlock(), createBlock(unref(A).reuse, normalizeProps(mergeProps({ key: 3 }, j.value)), null, 16)) : ee === -5 ? (openBlock(), createBlock(unref(K).reuse, { key: 4 })) : (openBlock(), createBlock(unref(A).reuse, normalizeProps(mergeProps({ key: 5 }, N(ee))), null, 16))
      ], 64))), 128))
    ], 10, xd));
  }
});
...
var Bn = defineComponent({
  ...
  setup(t) {
    ...
    return (a, o) => (openBlock(), createBlock(je, {
...
var jd = defineComponent({
  ...
  setup(t) {
    const e = t, l = computed(() => ({
      ...
      size: e.size,
      variant: e.variant
    })), a = toRef(() => e.noButton ? je : Bn);
    return (o, r) => (openBlock(), createBlock(un, { "img-bottom": o.imgBottom }, createSlots({
      default: withCtx(() => [
        renderSlot(o.$slots, "default", {}, () => [
          createVNode(je, mergeProps({ cols: "7" }, l.value), null, 16),
          createVNode(je, mergeProps({ cols: "4" }, l.value), null, 16),
          createVNode(je, mergeProps({ cols: "4" }, l.value), null, 16),
          createVNode(je, mergeProps({ cols: "6" }, l.value), null, 16),
          createVNode(je, mergeProps({ cols: "8" }, l.value), null, 16)
        ])
      ]),
      _: 2
    }, [
...
var ol = defineComponent({
  ...
  setup(t) {
    const e = t, l = computed(() => [
      ...
      computed(
        () => (e.stickyHeader === true ? qd : e.stickyHeader) || NaN
      )
    ), r = computed(() => e.stickyHeader !== false), n = computed(() => e.responsive !== false || r.value), s = computed(
    ...
    return (u, d) => n.value ? (openBlock(), createElementBlock("div", {
      key: 0,
...
var Wd = defineComponent({
  ...
  setup(t) {
    const e = t, l = be(() => e.columns), a = be(() => e.rows), o = toRef(() => e.headerColumns ?? NaN), r = toRef(() => e.footerColumns ?? NaN), n = be(o), s = be(r), i = toRef(() => l.value || 5), u = toRef(() => a.value || 3), d = toRef(
      () => e.headerColumns === void 0 ? i.value : n.value
    ), p = toRef(
      () => e.footerColumns === void 0 ? i.value : s.value
    );
    return (f, m) => (openBlock(), createBlock(ol, null, {
      default: withCtx(() => [
        e.hideHeader ? createCommentVNode("", true) : renderSlot(f.$slots, "thead", { key: 0 }, () => [
          createBaseVNode("thead", null, [
            createBaseVNode("tr", null, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(d.value, (y, c) => (openBlock(), createElementBlock("th", { key: c }, [
                createVNode(je, {
                  size: f.headerSize,
        ...
        renderSlot(f.$slots, "default", {}, () => [
          createBaseVNode("tbody", null, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(u.value, (y, c) => (openBlock(), createElementBlock("tr", { key: c }, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(i.value, (g, v) => (openBlock(), createElementBlock("td", { key: v }, [
                createVNode(je, {
                  size: f.size,
                  variant: f.variant,
        ...
        e.showFooter ? renderSlot(f.$slots, "tfoot", { key: 1 }, () => [
          createBaseVNode("tfoot", null, [
            createBaseVNode("tr", null, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(p.value, (y, c) => (openBlock(), createElementBlock("th", { key: c }, [
                createVNode(je, {
                  size: f.footerSize,
...
var Gd = defineComponent({
  ...
  setup(t) {
    const e = t;
    return (l, a) => e.loading ? renderSlot(l.$slots, "loading", { key: 0 }) : renderSlot(l.$slots, "default", { key: 1 });
  }
});
var Hl = fa("cols", [""], { type: [String, Number], default: null });
var Ud = defineComponent({
  ...
  setup(t) {
    const e = Dt(() => t.alignH), l = computed(() => Bo(t, Hl, "cols", "row-cols"));
    return {
      computedClasses: computed(() => [
        l.value,
        {
...
function Xd(t, e, l, a, o, r) {
  return openBlock(), createBlock(resolveDynamicComponent(t.tag), {
    class: normalizeClass(["row", t.computedClasses])
  }, {
    default: withCtx(() => [
      renderSlot(t.$slots, "default")
    ]),
...
var Kd = qt(Ud, [["render", Xd]]);
var ot = (t) => typeof t == "object" && t !== null;
var Ia = (t) => typeof t == "object" && t !== null && "key" in t;
...
var Yd = ["scope", "colspan", "rowspan", "data-label"];
var Jd = { key: 0 };
var St = defineComponent({
  ...
  setup(t) {
    ...
    return (o, r) => (openBlock(), createElementBlock("td", {
      scope: a.value,
      class: normalizeClass(l.value),
      colspan: o.colspan,
      rowspan: o.rowspan,
      ...
      o.stackedHeading ? (openBlock(), createElementBlock("div", Jd, [
        renderSlot(o.$slots, "default")
      ])) : renderSlot(o.$slots, "default", { key: 1 })
    ], 10, Yd));
  }
});
var Pa = defineComponent({
...
var Zd = ["scope", "colspan", "rowspan", "data-label"];
var Qd = { key: 0 };
var Ea = defineComponent({
  ...
  setup(t) {
    ...
    return (o, r) => (openBlock(), createElementBlock("th", {
      scope: a.value,
      class: normalizeClass(l.value),
      colspan: o.colspan,
      rowspan: o.rowspan,
      ...
      o.stackedHeading !== void 0 ? (openBlock(), createElementBlock("div", Qd, [
        renderSlot(o.$slots, "default")
      ])) : renderSlot(o.$slots, "default", { key: 1 })
    ], 10, Zd));
  }
...
var tc = { class: "d-inline-flex flex-nowrap align-items-center gap-1" };
var ac = { key: 2 };
var kn = defineComponent({
  ...
  setup(t, { emit: e }) {
    const l = t, a = e, o = ref(JSON.parse(JSON.stringify(l.items)));
    watch(
      () => l.items,
      (c) => {
    ...
    const r = computed(() => [
      ...
      if (!l.fields.length && o.value.length) {
        ...
        return ot(c) || Array.isArray(c) ? Object.keys(c).map((g) => {
          ...
          return {
            key: g,
            label: v,
            tdAttr: l.stacked === true ? { "data-label": v } : void 0
          };
        }) : [{ key: "", _noHeader: true }];
      }
      return l.fields.map((c) => {
        if (Ia(c))
          return {
            ...c,
            tdAttr: l.stacked === true ? { "data-label": ya(c.key), ...c.tdAttr } : c.tdAttr
          };
        const g = ya(c);
        return {
          key: c,
          label: g,
          tdAttr: l.stacked === true ? { "data-label": g } : void 0
        };
      });
    }), s = toRef(() => n.value.length), i = computed(() => !(n.value.length > 0 && n.value.every((c) => c._noHeader === true))), u = (c, g, v) => {
      const h2 = Je(c, g);
      return v && typeof v == "function" ? v(h2, g, c) : v;
    }, d = (c, g, v = false) => {
      ...
      return [
        c.class,
        c.tdClass,
        ot(g) && (v = g._cellVariants) != null && v[c.key] ? `table-${(h2 = g._cellVariants) == null ? void 0 : h2[c.key]}` : null,
        {
          "b-table-sticky-column": c.stickyColumn
        }
      ];
    }, y = (c, g) => l.tbodyTrClass ? typeof l.tbodyTrClass == "function" ? l.tbodyTrClass(c, g) : l.tbodyTrClass : null;
    return (c, g) => (openBlock(), createBlock(ol, {
      id: c.id,
      bordered: c.bordered,
      ...
      default: withCtx(() => [
        withDirectives(createVNode(Cn, {
          ...
          default: withCtx(() => [
            ...
            createVNode(Ye, {
              ...
              default: withCtx(() => [
                (openBlock(true), createElementBlock(Fragment, null, renderList(n.value, (v) => (openBlock(), createBlock(Ea, mergeProps({
                  key: v.key,
                  scope: "col",
                  class: f(v),
                  title: v.headerTitle,
                  ...
                  default: withCtx(() => [
                    renderSlot(c.$slots, c.$slots[`head(${String(v.key)})`] ? `head(${String(v.key)})` : "head()", {
                      label: v.label,
                      column: v.key,
                      field: v,
                      isFoot: false
                    }, () => [
                      createTextVNode(toDisplayString(unref(Zt)(v)), 1)
                    ])
                  ]),
                  _: 2
            ...
            c.$slots["thead-sub"] ? (openBlock(), createBlock(Ye, { key: 1 }, {
              default: withCtx(() => [
                (openBlock(true), createElementBlock(Fragment, null, renderList(n.value, (v) => (openBlock(), createBlock(St, {
                  key: v.key,
                  scope: "col",
                  variant: v.variant,
                  class: normalizeClass([v.class, v.thClass])
                }, {
                  default: withCtx(() => [
                    renderSlot(c.$slots, "thead-sub", mergeProps({ items: n.value }, v), () => [
                      createTextVNode(toDisplayString(v.label), 1)
                    ])
                  ]),
                  _: 2
        ...
        createVNode(wn, {
          ...
          default: withCtx(() => [
            renderSlot(c.$slots, "custom-body", {
              ...
              !l.stacked && c.$slots["top-row"] ? (openBlock(), createBlock(Ye, { key: 0 }, {
                default: withCtx(() => [
                  renderSlot(c.$slots, "top-row")
                ]),
                _: 3
              })) : createCommentVNode("", true),
              (openBlock(true), createElementBlock(Fragment, null, renderList(o.value, (v, h2) => (openBlock(), createElementBlock(Fragment, { key: h2 }, [
                createVNode(Ye, {
                  class: normalizeClass(y(v, "row")),
                  variant: unref(ot)(v) ? v._rowVariant : void 0,
                  onClick: (k) => !unref(Gt)(k) && a("row-clicked", v, h2, k),
                  onDblclick: (k) => !unref(Gt)(k) && a("row-dbl-clicked", v, h2, k),
                  onMouseenter: (k) => !unref(Gt)(k) && a("row-hovered", v, h2, k),
                  onMouseleave: (k) => !unref(Gt)(k) && a("row-unhovered", v, h2, k)
                }, {
                  default: withCtx(() => [
                    (openBlock(true), createElementBlock(Fragment, null, renderList(n.value, (k) => {
                      var C;
                      return openBlock(), createBlock(St, mergeProps({
                        key: k.key,
                        variant: unref(ot)(v) && (C = v._cellVariants) != null && C[k.key] ? null : k.variant,
                        class: m(k, v)
                      }, u(v, String(k.key), k.tdAttr)), {
                        default: withCtx(() => [
                          l.stacked && l.labelStacked ? (openBlock(), createElementBlock("label", ec, toDisplayString(unref(Zt)(k)), 1)) : createCommentVNode("", true),
                          renderSlot(
                            c.$slots,
                            c.$slots[`cell(${String(k.key)})`] ? `cell(${String(k.key)})` : "cell()",
                            {
                              value: unref(Je)(v, String(k.key)),
                              index: h2,
                              item: v,
                              field: k,
                              items: o.value,
                              ...
                              detailsShowing: unref(ot)(v) ? v._showDetails ?? false : false
                            },
                            () => [
                              !c.$slots[`cell(${String(k.key)})`] && !c.$slots["cell()"] ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                                createTextVNode(toDisplayString(unref(ho)(v, String(k.key), k.formatter)), 1)
                              ], 64)) : createCommentVNode("", true)
                            ]
                          )
                        ]),
                ...
                unref(ot)(v) && v._showDetails === true && c.$slots["row-details"] ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                  createVNode(Ye, {
                    "aria-hidden": "true",
                    role: "presentation",
                    class: "d-none"
                  ...
                  createVNode(Ye, {
                    class: normalizeClass(y(v, "row-details")),
                    variant: v._rowVariant
                  }, {
                    default: withCtx(() => [
                      createVNode(St, { colspan: s.value }, {
                        default: withCtx(() => [
              ...
              l.showEmpty && o.value.length === 0 ? (openBlock(), createBlock(Ye, {
                key: 1,
                ...
                default: withCtx(() => [
                  createVNode(St, { colspan: s.value }, {
                    default: withCtx(() => [
                      renderSlot(c.$slots, "empty", { items: o.value }, () => [
              ...
              !l.stacked && c.$slots["bottom-row"] ? (openBlock(), createBlock(Ye, { key: 2 }, {
                default: withCtx(() => [
        ...
        l.footClone ? (openBlock(), createBlock(Pa, {
          key: 0,
          ...
          _: 3
        }, 8, ["variant", "class"])) : c.$slots["custom-foot"] ? (openBlock(), createBlock(Pa, { key: 1 }, {
          default: withCtx(() => [
        ...
        c.$slots["table-caption"] || c.caption ? (openBlock(), createElementBlock("caption", ac, [
...
var ic = { class: "d-flex align-items-center gap-2 mt-5" };
var uc = defineComponent({
  ...
  emits: mergeModels(["filtered", "head-clicked", "row-clicked", "row-dbl-clicked", "row-hovered", "row-unhovered", "row-selected", "row-unselected", "selection", "sorted"], ["update:sortBy", "update:busy", "update:selectedItems"]),
  setup(t, { expose: e, emit: l }) {
    const a = t, o = l, r = useModel(t, "sortBy"), n = useModel(t, "busy"), s = useModel(t, "selectedItems"), i = computed({
      ...
      */
    ...
    }, d = ref([]), p = be(() => a.perPage, { method: "parseInt" }), f = be(() => a.currentPage, { method: "parseInt" }), m = toRef(() => !!a.filter), y = toRef(() => a.provider !== void 0), c = toRef(() => i.value.size > 0), g = computed(
      () => r.value !== void 0 || a.fields.some(
        (S) => typeof S == "object" && S !== null && S.sortable === true
      )
    ), v = computed(
      () => a.fields.map((S) => {
        var j;
        if (!(typeof S == "object" && S !== null))
          return S;
        const E = (j = r.value) == null ? void 0 : j.find((A) => S.key === A.key), M = g.value === false ? void 0 : E === void 0 ? "none" : E.order === "desc" ? "descending" : "ascending";
        return {
          ...S,
          thAttr: {
            "aria-sort": M,
      ...
      const S = (j) => {
        ...
        return !A || A.length === 0 ? j : [...j].sort((G, ie) => {
          for (let q = 0; q < (A.length ?? 0); q++) {
            const ne = A[q], ge = (U) => {
              if (!ot(U))
                return String(U);
              const z = v.value.find((fe) => Ia(fe) ? fe.key === ne.key : false), oe = U[ne.key];
            ...
            }, te = ge(G), ye = ge(ie), ee = ne.comparer ? ne.comparer(te, ye) : te.localeCompare(ye, void 0, { numeric: true });
            if (ee !== 0)
        ...
        (A) => ot(A) ? Object.entries(A).some(([K, G]) => {
          var q, ne, ge;
          return G == null || K[0] === "_" || !((q = a.filterable) != null && q.includes(K)) && ((ne = a.filterable) != null && ne.length) ? false : (typeof G == "object" ? JSON.stringify(Object.values(G)) : G.toString()).toLowerCase().includes(((ge = a.filter) == null ? void 0 : ge.toLowerCase()) ?? "");
        }) : true
      );
      ...
      return M = M.map((j) => {
        ...
        return j;
      }), (m.value === true && !y.value || m.value === true && y.value && a.noProviderFiltering) && (M = E(M)), (g.value === true && !y.value && !a.noLocalSorting || g.value === true && y.value && a.noProviderSorting) && (M = S(M)), M;
    }), F = computed(() => Number.isNaN(p.value) || y.value && !a.noProviderPaging ? _.value : _.value.slice(
      (f.value - 1) * (p.value || Number.POSITIVE_INFINITY),
      f.value * (p.value || Number.POSITIVE_INFINITY)
    )), Q = (S, E, M = false, j = false, A = false) => {
      if (a.selectable) {
      ...
      a.noSelectOnClick === false && Q(S, E, M.shiftKey, M.ctrlKey, M.metaKey), o("row-clicked", S, E, M);
    }, L = (S) => {
      var ne, ge;
      if (!g.value)
        return;
      const E = typeof S == "object" && S !== null ? S.key : S, M = typeof S == "object" && S !== null ? S.sortable : false;
      if (!(g.value === true && M === true))
        return;
      const j = (te) => {
        if (te === "asc")
          return "desc";
        if (te === void 0 || a.mustSort === true || Array.isArray(a.mustSort) && a.mustSort.includes(E))
          return "asc";
      ...
      o("sorted", a.multisort === true ? ie() : q());
    }, J = (S, E, M, j = false) => {
      ...
      const j = (ie) => {
        var q;
        return ((q = a.noProvider) == null ? void 0 : q.includes(ie)) === true;
      }, A = (S === "currentPage" || S === "perPage") && (j("paging") || a.noProviderPaging === true), K = S === "filter" && (j("filtering") || a.noProviderFiltering === true), G = (S === "sortBy" || S === "sortDesc") && (j("sorting") || a.noProviderSorting === true);
      A || K || G || (y.value === true && await R(), S === "currentPage" || S === "perPage" || o("filtered", [..._.value]));
    };
    return watch(
      () => a.filter,
      (S, E) => {
    ...
    }), (S, E) => (openBlock(), createBlock(kn, mergeProps(a, {
      "aria-busy": n.value,
      items: F.value,
      fields: v.value,
      "table-class": h2.value,
      "tbody-tr-class": w,
      ...
      "head()": withCtx((M) => {
        var j, A, K, G;
        return [
          createTextVNode(toDisplayString(unref(Zt)(M.field)) + " ", 1),
          g.value && M.field.sortable && a.noSortableIcon === false ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
            ((A = (j = r.value) == null ? void 0 : j.find((ie) => ie.key === M.field.key)) == null ? void 0 : A.order) === "asc" ? renderSlot(
              S.$slots,
              S.$slots[`sortAsc(${String(M.field.key)})`] ? `sortAsc(${String(M.field.key)})` : "sortAsc()",
              normalizeProps(mergeProps({ key: 0 }, { ...M })),
              () => [
                lc
              ]
            ) : ((G = (K = r.value) == null ? void 0 : K.find((ie) => ie.key === M.field.key)) == null ? void 0 : G.order) === "desc" ? renderSlot(
              S.$slots,
              S.$slots[`sortDesc(${String(M.field.key)})`] ? `sortDesc(${String(M.field.key)})` : "sortDesc()",
              normalizeProps(mergeProps({ key: 1 }, { ...M })),
              () => [
                oc
              ]
            ) : renderSlot(
              ...
              normalizeProps(mergeProps({ key: 2 }, { ...M })),
              () => [
                (openBlock(), createElementBlock("svg", nc, rc))
              ]
            )
          ], 64)) : createCommentVNode("", true)
        ];
      }),
      "custom-body": withCtx((M) => [
        n.value ? (openBlock(), createBlock(Ye, {
          key: 0,
          class: normalizeClass(["b-table-busy-slot", k.value])
        }, {
          default: withCtx(() => [
            createVNode(St, {
                  ...
                  createVNode(ma, { show: "" }, {
                    overlay: withCtx(() => [
                      createBaseVNode("div", ic, [
                        createVNode(pa),
                        createBaseVNode("strong", null, toDisplayString(S.busyLoadingText), 1)
                      ])
                    ]),
                    _: 1
                  })
      ...
      renderList(S.$slots, (M, j) => ({
        name: j,
        fn: withCtx((A) => [
          renderSlot(S.$slots, j, normalizeProps(guardReactiveProps(A)))
        ])
      }))
...
var dc = defineComponent({
  ...
  emits: ["update:active"],
  setup(t) {
    const e = t, l = useSlots(), a = useModel(t, "active"), o = inject($o, null), r = Be(() => e.id, "tabpane"), n = Be(() => e.buttonId, "tab"), s = ref(false), i = ref(null), { onClick: u, ...d } = useAttrs(), p = computed(
      () => ({
        id: r.value,
        buttonId: n.value,
        disabled: e.disabled,
    ...
    const f = toRef(() => (o == null ? void 0 : o.activeId.value) === r.value), m = ref(f.value), y = toRef(() => !!(o != null && o.lazy.value || (e.lazyOnce ?? e.lazy))), c = toRef(() => e.lazyOnce !== void 0), g = toRef(() => f.value && !e.disabled), v = toRef(
    ...
    const h2 = computed(() => [
      {
        active: f.value,
        show: m.value,
        "card-body": (o == null ? void 0 : o.card.value) && e.noBody === false,
    ...
    return watch(v, (k) => {
      k && !s.value && (s.value = true);
    }), (k, C) => (openBlock(), createBlock(resolveDynamicComponent(k.tag), mergeProps({
      id: unref(r),
      ref_key: "el",
      ref: i,
      class: ["tab-pane", h2.value],
      role: "tabpanel",
      "aria-labelledby": unref(n)
    }, d), {
      default: withCtx(() => [
        v.value ? renderSlot(k.$slots, "default", { key: 0 }) : createCommentVNode("", true)
      ]),
      _: 3
    }, 16, ["id", "class", "aria-labelledby"]));
  }
});
var cc = ["aria-orientation"];
var fc = ["id", "aria-controls", "aria-selected", "onClick"];
var vc = defineComponent({
  ...
  setup(t, { emit: e }) {
    const l = t, a = e, o = useModel(t, "modelValue"), r = useModel(t, "activeId"), n = zt(), s = ref([]), i = computed(
      () => s.value.map((C) => {
        const w = unref(C), _ = w.id === r.value;
        return {
          ...w,
          active: _,
          navItemClasses: [
    ...
    ), u = toRef(() => !(i != null && i.value && i.value.length > 0)), d = computed(() => ({
      "d-flex": l.vertical,
      "align-items-start": l.vertical
    })), p = Dt(() => l.align), f = computed(() => ({
      "nav-pills": l.pills,
      ...
      if (C !== void 0) {
        ...
        if (C > -1 && C < i.value.length && !i.value[C].disabled && (o.value < 0 || r.value !== _ || o.value !== C)) {
          const F = new nt("activate-tab", { cancelable: true });
    ...
    const k = () => {
      ...
      m(i.value.map((w) => !w.disabled).indexOf(true));
    };
    return provide($o, {
      lazy: toRef(() => l.lazy),
      card: toRef(() => l.card),
      noFade: toRef(() => l.noFade),
      activeTabClass: toRef(() => l.activeTabClass),
      inactiveTabClass: toRef(() => l.inactiveTabClass),
      tabClass: toRef(() => l.tabClass),
      registerTab: v,
      unregisterTab: h2,
      activeId: r,
      activateTab: (C) => {
    ...
    }), (C, w) => (openBlock(), createBlock(resolveDynamicComponent(C.tag), {
      id: C.id,
      class: normalizeClass(["tabs", d.value])
    }, {
      default: withCtx(() => [
        createVNode(unref(n).define, null, {
          default: withCtx(() => [
            createBaseVNode("div", {
              class: normalizeClass(["tab-content", C.contentClass])
            }, [
              renderSlot(C.$slots, "default"),
              u.value ? (openBlock(), createElementBlock("div", {
                key: "bv-empty-tab",
                class: normalizeClass(["tab-pane active", { "card-body": l.card }])
              }, [
        ...
        l.end ? (openBlock(), createBlock(unref(n).reuse, { key: 0 })) : createCommentVNode("", true),
        createBaseVNode("div", {
          class: normalizeClass([C.navWrapperClass, { "card-header": l.card, "ms-auto": C.vertical && l.end }])
        }, [
          createBaseVNode("ul", {
            class: normalizeClass(["nav", [f.value, C.navClass]]),
            role: "tablist",
            "aria-orientation": C.vertical ? "vertical" : "horizontal"
          }, [
            renderSlot(C.$slots, "tabs-start"),
            (openBlock(true), createElementBlock(Fragment, null, renderList(i.value, (_, F) => (openBlock(), createElementBlock("li", {
              key: _.id,
              class: normalizeClass(["nav-item", _.titleItemClass]),
              role: "presentation"
            }, [
              createBaseVNode("button", mergeProps({
                ...
                onKeydown: [
                  w[0] || (w[0] = withKeys(withModifiers((Q) => c(-1), ["stop", "prevent"]), ["left"])),
                  w[1] || (w[1] = withKeys(withModifiers((Q) => c(1), ["stop", "prevent"]), ["right"])),
                  w[2] || (w[2] = withKeys(withModifiers((Q) => c(-999), ["stop", "prevent"]), ["page-up"])),
                  w[3] || (w[3] = withKeys(withModifiers((Q) => c(999), ["stop", "prevent"]), ["page-down"]))
                ],
                onClick: withModifiers((Q) => y(Q, F), ["stop", "prevent"])
              }), [
                _.titleComponent ? (openBlock(), createBlock(resolveDynamicComponent(_.titleComponent), { key: 0 })) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
        ...
        l.end ? createCommentVNode("", true) : (openBlock(), createBlock(unref(n).reuse, { key: 1 }))
      ]),
      _: 3
    }, 8, ["id", "class"]));
  }
});
var pc = { id: "__BVID__toaster-container" };
var mc = defineComponent({
  ...
  setup(t, { expose: e }) {
    ...
    return e({
      ...
      show: n,
      toasts: r
    }), (u, d) => (openBlock(), createBlock(Teleport, {
      to: u.teleportTo,
      disabled: l.teleportDisabled
    }, [
      createBaseVNode("div", pc, [
        (openBlock(), createElementBlock(Fragment, null, renderList(a, (p, f) => createBaseVNode("div", {
          key: f,
          ...
          createVNode(TransitionGroup, { name: "b-list" }, {
            default: withCtx(() => {
              var m;
              return [
                (openBlock(true), createElementBlock(Fragment, null, renderList((m = unref(r)) == null ? void 0 : m.filter((y) => y.value.props.pos === f), (y) => (openBlock(), createBlock(resolveDynamicComponent(y.value.component), mergeProps({
                  key: y.value.props._self
                }, i(y.value.props), {
                  modelValue: y.value.props._modelValue,
                  "onUpdate:modelValue": (c) => y.value.props._modelValue = c,
                  "trans-props": { ...y.value.props.transProps, appear: true },
                  onHide: withModifiers((c) => {
                    var g;
                    return (g = unref(o)) == null ? void 0 : g(y.value.props._self);
                  }, ["prevent"])
...
var bc = defineComponent({
  ...
  setup(t, { expose: e }) {
    var n, s, i;
    const l = t, a = useModel(t, "modelValue"), o = computed(() => {
    ...
    return e({
    ...
    }), (u, d) => (openBlock(), createBlock(Xa, mergeProps({
      ref_key: "popover",
      ref: r
    }, o.value, {
      modelValue: a.value,
      ...
      renderList(u.$slots, (p, f) => ({
        name: f,
        fn: withCtx((m) => [
          renderSlot(u.$slots, f, normalizeProps(guardReactiveProps(m)))
        ])
      }))
    ]), 1040, ["modelValue"]));
  }
...
var Bc = Object.freeze(Object.defineProperty({
  __proto__: null,
  BvCarouselEvent: ql,
  BvEvent: nt,
...
var Cc = ({
  ...
  install(a) {
    ...
    Bl(n, s).forEach((u) => {
      const d = i(u), p = Ll[u];
      a.directive(d, p);
    }), ((l == null ? void 0 : l.breadcrumb) ?? true) && a.use(Wr), (((l == null ? void 0 : l.id) ?? true) || typeof l.id == "object") && a.use(Gr, l), ((l == null ? void 0 : l.modalController) ?? true) && a.use(Jr), ((l == null ? void 0 : l.modalManager) ?? true) && a.use(Zr), (((l == null ? void 0 : l.rtl) ?? true) || typeof l.rtl == "object") && a.use(Qr, l), ((l == null ? void 0 : l.toast) ?? true) && a.use(qr);
  }
});
export {
  ti as BAccordion,
